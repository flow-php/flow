 ...
 *
 * Auto-generated on 2025\u002D11\u002D04\u002017\u003A20\u003A58
 * Total functions: 341
 *
    ...
    var flowDslCompleter = {
        getCompletions: function(editor, session, pos, prefix, callback) {
            ...
            var allCompletions = [
                    ...
                    snippet: "add_row_index(${1:string $column}, ${2:StartFrom $startFrom})",
                    ...
                    name: "all",
                    caption: "all",
                    snippet: "all(${1:ScalarFunction $functions})",
                    ...
                    name: "any",
                    caption: "any",
                    snippet: "any(${1:ScalarFunction $values})",
                    meta: "flow-dsl-scalar-functions",
                    score: 1_000,
                    ...
                    snippet: "array_exists(${1:ScalarFunction|array $ref}, ${2:ScalarFunction|string $path})",
                    meta: "flow-dsl-scalar-functions",
                    score: 1_000,
                    ...
                    snippet: "array_expand(${1:ScalarFunction $function}, ${2:ArrayExpand $expand})",
                    meta: "flow-dsl-scalar-functions",
                    score: 1_000,
                    ...
                    name: "array_get",
                    caption: "array_get",
                    snippet: "array_get(${1:ScalarFunction $ref}, ${2:ScalarFunction|string $path})",
                    meta: "flow-dsl-scalar-functions",
                    score: 1_000,
                    ...
                    snippet: "array_get_collection(${1:ScalarFunction $ref}, ${2:ScalarFunction|array $keys})",
                    meta: "flow-dsl-scalar-functions",
                    score: 1_000,
                    ...
                    snippet: "array_get_collection_first(${1:ScalarFunction $ref}, ${2:string $keys})",
                    meta: "flow-dsl-scalar-functions",
                    score: 1_000,
                    ...
                    snippet: "array_keys_style_convert(${1:ScalarFunction $ref}, ${2:StringStyles|StringStyles|string $style})",
                    meta: "flow-dsl-scalar-functions",
                    score: 1_000,
                    ...
                    snippet: "array_key_rename(${1:ScalarFunction $ref}, ${2:ScalarFunction|string $path}, ${3:ScalarFunction|string $newName})",
                    meta: "flow-dsl-scalar-functions",
                    score: 1_000,
                    ...
                    name: "array_merge",
                    caption: "array_merge",
                    snippet: "array_merge(${1:ScalarFunction|array $left}, ${2:ScalarFunction|array $right})",
                    meta: "flow-dsl-scalar-functions",
                    score: 1_000,
                    ...
                    snippet: "array_merge_collection(${1:ScalarFunction|array $array})",
                    meta: "flow-dsl-scalar-functions",
                    score: 1_000,
                    ...
                    snippet: "array_reverse(${1:ScalarFunction|array $function}, ${2:ScalarFunction|bool $preserveKeys})",
                    meta: "flow-dsl-scalar-functions",
                    score: 1_000,
                    ...
                    name: "array_sort",
                    caption: "array_sort",
                    snippet: "array_sort(${1:ScalarFunction $function}, ${2:ScalarFunction|Sort|null $sort_function}, ${3:ScalarFunction|int|null $flags}, ${4:ScalarFunction|bool $recursive})",
                    meta: "flow-dsl-scalar-functions",
                    score: 1_000,
                    ...
                    snippet: "array_to_generator(${1:array $data})",
                    meta: "flow-dsl-helpers",
                    score: 1_000,
                    ...
                    snippet: "array_to_row(${1:array $data}, ${2:EntryFactory $entryFactory}, ${3:Partitions|array $partitions}, ${4:Schema $schema})",
                    meta: "flow-dsl-data-frame",
                    score: 1_000,
                    ...
                    snippet: "array_to_rows(${1:array $data}, ${2:EntryFactory $entryFactory}, ${3:Partitions|array $partitions}, ${4:Schema $schema})",
                    meta: "flow-dsl-data-frame",
                    score: 1_000,
                    ...
                    snippet: "array_unpack(${1:ScalarFunction|array $array}, ${2:ScalarFunction|array $skip_keys}, ${3:ScalarFunction|string|null $entry_prefix})",
                    meta: "flow-dsl-scalar-functions",
                    score: 1_000,
                    ...
                    name: "average",
                    caption: "average",
                    snippet: "average(${1:EntryReference|string $ref}, ${2:int $scale}, ${3:Rounding $rounding})",
                    ...
                    snippet: "aws_s3_client(${1:array $configuration})",
                    meta: "flow-dsl-helpers",
                    score: 1_000,
                    ...
                    snippet: "aws_s3_filesystem(${1:string $bucket}, ${2:S3Client $s3Client}, ${3:Options $options})",
                    meta: "flow-dsl-helpers",
                    score: 1_000,
                    ...
                    snippet: "azure_blob_service(${1:Configuration $configuration}, ${2:AuthorizationFactory $azure_authorization_factory}, ${3:ClientInterface $client}, ${4:HttpFactory $azure_http_factory}, ${5:URLFactory $azure_url_factory}, ${6:LoggerInterface $logger})",
                    meta: "flow-dsl-helpers",
                    score: 1_000,
                    ...
                    snippet: "azure_blob_service_config(${1:string $account}, ${2:string $container})",
                    meta: "flow-dsl-helpers",
                    score: 1_000,
                    ...
                    snippet: "azure_filesystem(${1:BlobServiceInterface $blob_service}, ${2:Options $options})",
                    meta: "flow-dsl-helpers",
                    score: 1_000,
                    ...
                    snippet: "azure_filesystem_options()",
                    meta: "flow-dsl-helpers",
                    score: 1_000,
                    ...
                    snippet: "azure_http_factory(${1:RequestFactoryInterface $request_factory}, ${2:StreamFactoryInterface $stream_factory})",
                    meta: "flow-dsl-helpers",
                    score: 1_000,
                    ...
                    snippet: "azure_shared_key_authorization_factory(${1:string $account}, ${2:string $key})",
                    meta: "flow-dsl-helpers",
                    score: 1_000,
                    ...
                    snippet: "azure_url_factory(${1:string $host})",
                    meta: "flow-dsl-helpers",
                    score: 1_000,
                    ...
                    snippet: "azurite_url_factory(${1:string $host}, ${2:string $port}, ${3:bool $secure})",
                    meta: "flow-dsl-helpers",
                    score: 1_000,
                    ...
                    name: "bar_chart",
                    caption: "bar_chart",
                    snippet: "bar_chart(${1:EntryReference $label}, ${2:References $datasets})",
                    meta: "flow-dsl-helpers",
                    score: 1_000,
                    ...
                    name: "batched_by",
                    caption: "batched_by",
                    snippet: "batched_by(${1:Extractor $extractor}, ${2:Reference|string $column}, ${3:int $min_size})",
                    ...
                    name: "batches",
                    caption: "batches",
                    snippet: "batches(${1:Extractor $extractor}, ${2:int $size})",
                    meta: "flow-dsl-extractors",
                    score: 1_000,
                    ...
                    name: "between",
                    caption: "between",
                    snippet: "between(${1:mixed $value}, ${2:mixed $lower_bound}, ${3:mixed $upper_bound}, ${4:ScalarFunction|Boundary $boundary})",
                    meta: "flow-dsl-scalar-functions",
                    score: 1_000,
                    ...
                    snippet: "boolean_entry(${1:string $name}, ${2:bool $value}, ${3:Metadata $metadata})",
                    ...
                    name: "bool_entry",
                    caption: "bool_entry",
                    snippet: "bool_entry(${1:string $name}, ${2:bool $value}, ${3:Metadata $metadata})",
                    meta: "flow-dsl-entries",
                    score: 1_000,
                    ...
                    name: "bool_schema",
                    caption: "bool_schema",
                    snippet: "bool_schema(${1:string $name}, ${2:bool $nullable}, ${3:Metadata $metadata})",
                    ...
                    name: "call",
                    caption: "call",
                    snippet: "call(${1:ScalarFunction|callable $callable}, ${2:array $parameters}, ${3:Type $return_type})",
                    meta: "flow-dsl-scalar-functions",
                    score: 1_000,
                    ...
                    name: "capitalize",
                    caption: "capitalize",
                    snippet: "capitalize(${1:ScalarFunction|string $value})",
                    meta: "flow-dsl-scalar-functions",
                    score: 1_000,
                    ...
                    name: "cast",
                    caption: "cast",
                    snippet: "cast(${1:mixed $value}, ${2:Type|string $type})",
                    meta: "flow-dsl-scalar-functions",
                    score: 1_000,
                    ...
                    name: "chunks_from",
                    caption: "chunks_from",
                    snippet: "chunks_from(${1:Extractor $extractor}, ${2:int $chunk_size})",
                    meta: "flow-dsl-extractors",
                    score: 1_000,
                    ...
                    name: "coalesce",
                    caption: "coalesce",
                    snippet: "coalesce(${1:ScalarFunction $values})",
                    meta: "flow-dsl-scalar-functions",
                    score: 1_000,
                    ...
                    name: "collect",
                    caption: "collect",
                    snippet: "collect(${1:EntryReference|string $ref})",
                    meta: "flow-dsl-aggregating-functions",
                    score: 1_000,
                    ...
                    snippet: "collect_unique(${1:EntryReference|string $ref})",
                    meta: "flow-dsl-aggregating-functions",
                    score: 1_000,
                    ...
                    name: "combine",
                    caption: "combine",
                    snippet: "combine(${1:ScalarFunction|array $keys}, ${2:ScalarFunction|array $values})",
                    meta: "flow-dsl-scalar-functions",
                    score: 1_000,
                    ...
                    name: "compare_all",
                    caption: "compare_all",
                    snippet: "compare_all(${1:Comparison $comparisons})",
                    ...
                    name: "compare_any",
                    caption: "compare_any",
                    snippet: "compare_any(${1:Comparison $comparisons})",
                    meta: "flow-dsl-comparisons",
                    score: 1_000,
                    ...
                    snippet: "compare_entries_by_name(${1:Order $order})",
                    meta: "flow-dsl-data-frame",
                    score: 1_000,
                    ...
                    snippet: "compare_entries_by_name_desc()",
                    meta: "flow-dsl-data-frame",
                    score: 1_000,
                    ...
                    snippet: "compare_entries_by_type(${1:array $priorities}, ${2:Order $order})",
                    meta: "flow-dsl-data-frame",
                    score: 1_000,
                    ...
                    snippet: "compare_entries_by_type_and_name(${1:array $priorities}, ${2:Order $order})",
                    meta: "flow-dsl-data-frame",
                    score: 1_000,
                    ...
                    snippet: "compare_entries_by_type_desc(${1:array $priorities})",
                    meta: "flow-dsl-data-frame",
                    score: 1_000,
                    ...
                    name: "concat",
                    caption: "concat",
                    snippet: "concat(${1:ScalarFunction|string $functions})",
                    meta: "flow-dsl-scalar-functions",
                    score: 1_000,
                    ...
                    name: "concat_ws",
                    caption: "concat_ws",
                    snippet: "concat_ws(${1:ScalarFunction|string $separator}, ${2:ScalarFunction|string $functions})",
                    meta: "flow-dsl-scalar-functions",
                    score: 1_000,
                    ...
                    snippet: "constraint_sorted_by(${1:Reference|string $column}, ${2:Reference|string $columns})",
                    meta: "flow-dsl-helpers",
                    score: 1_000,
                    ...
                    snippet: "constraint_unique(${1:string $reference}, ${2:string $references})",
                    meta: "flow-dsl-helpers",
                    score: 1_000,
                    ...
                    name: "count",
                    caption: "count",
                    snippet: "count(${1:EntryReference $function})",
                    meta: "flow-dsl-aggregating-functions",
                    score: 1_000,
                    ...
                    snippet: "csv_detect_separator(${1:SourceStream $stream}, ${2:int $lines}, ${3:Option $fallback}, ${4:Options $options})",
                    meta: "flow-dsl-helpers",
                    score: 1_000,
                    ...
                    name: "data_frame",
                    caption: "data_frame",
                    snippet: "data_frame(${1:Config|ConfigBuilder|null $config})",
                    meta: "flow-dsl-data-frame",
                    score: 1_000,
                    ...
                    snippet: "datetime_entry(${1:string $name}, ${2:DateTimeInterface|string|null $value}, ${3:Metadata $metadata})",
                    meta: "flow-dsl-entries",
                    score: 1_000,
                    ...
                    snippet: "datetime_schema(${1:string $name}, ${2:bool $nullable}, ${3:Metadata $metadata})",
                    meta: "flow-dsl-schema",
                    score: 1_000,
                    ...
                    name: "date_entry",
                    caption: "date_entry",
                    snippet: "date_entry(${1:string $name}, ${2:DateTimeInterface|string|null $value}, ${3:Metadata $metadata})",
                    meta: "flow-dsl-entries",
                    score: 1_000,
                    ...
                    snippet: "date_interval_to_microseconds(${1:DateInterval $interval})",
                    meta: "flow-dsl-helpers",
                    score: 1_000,
                    ...
                    snippet: "date_interval_to_milliseconds(${1:DateInterval $interval})",
                    meta: "flow-dsl-helpers",
                    score: 1_000,
                    ...
                    snippet: "date_interval_to_seconds(${1:DateInterval $interval})",
                    meta: "flow-dsl-helpers",
                    score: 1_000,
                    ...
                    name: "date_schema",
                    caption: "date_schema",
                    snippet: "date_schema(${1:string $name}, ${2:bool $nullable}, ${3:Metadata $metadata})",
                    meta: "flow-dsl-schema",
                    score: 1_000,
                    ...
                    snippet: "date_time_format(${1:ScalarFunction $ref}, ${2:string $format})",
                    meta: "flow-dsl-scalar-functions",
                    score: 1_000,
                    ...
                    snippet: "dbal_dataframe_factory(${1:Connection|array $connection}, ${2:string $query}, ${3:QueryParameter $parameters})",
                    meta: "flow-dsl-helpers",
                    score: 1_000,
                    ...
                    snippet: "dbal_from_queries(${1:Connection $connection}, ${2:string $query}, ${3:ParametersSet $parameters_set}, ${4:array $types})",
                    meta: "flow-dsl-extractors",
                    score: 1_000,
                    ...
                    snippet: "dbal_from_query(${1:Connection $connection}, ${2:string $query}, ${3:array $parameters}, ${4:array $types})",
                    meta: "flow-dsl-extractors",
                    score: 1_000,
                    ...
                    snippet: "delay_exponential(${1:Duration $base}, ${2:int $multiplier}, ${3:Duration $max_delay})",
                    meta: "flow-dsl-helpers",
                    score: 1_000,
                    ...
                    name: "delay_fixed",
                    caption: "delay_fixed",
                    snippet: "delay_fixed(${1:Duration $delay})",
                    meta: "flow-dsl-helpers",
                    score: 1_000,
                    ...
                    snippet: "delay_jitter(${1:DelayFactory $delay}, ${2:float $jitter_factor})",
                    meta: "flow-dsl-helpers",
                    score: 1_000,
                    ...
                    snippet: "delay_linear(${1:Duration $delay}, ${2:Duration $increment})",
                    meta: "flow-dsl-helpers",
                    score: 1_000,
                    ...
                    name: "df",
                    caption: "df",
                    snippet: "df(${1:Config|ConfigBuilder|null $config})",
                    meta: "flow-dsl-data-frame",
                    score: 1_000,
                    ...
                    snippet: "dom_element_to_string(${1:DOMElement $element}, ${2:bool $format_output}, ${3:bool $preserver_white_space})",
                    meta: "flow-dsl-data-frame",
                    score: 1_000,
                    ...
                    name: "drop",
                    caption: "drop",
                    snippet: "drop(${1:Reference|string $entries})",
                    meta: "flow-dsl-transformers",
                    score: 1_000,
                    ...
                    snippet: "duration_microseconds(${1:int $microseconds})",
                    meta: "flow-dsl-helpers",
                    score: 1_000,
                    ...
                    snippet: "duration_milliseconds(${1:int $milliseconds})",
                    meta: "flow-dsl-helpers",
                    score: 1_000,
                    ...
                    snippet: "duration_minutes(${1:int $minutes})",
                    meta: "flow-dsl-helpers",
                    score: 1_000,
                    ...
                    snippet: "duration_seconds(${1:int $seconds})",
                    meta: "flow-dsl-helpers",
                    score: 1_000,
                    ...
                    name: "entries",
                    caption: "entries",
                    snippet: "entries(${1:Entry $entries})",
                    meta: "flow-dsl-data-frame",
                    score: 1_000,
                    ...
                    snippet: "entry_id_factory(${1:string $entry_name})",
                    meta: "flow-dsl-helpers",
                    score: 1_000,
                    ...
                    name: "enum_entry",
                    caption: "enum_entry",
                    snippet: "enum_entry(${1:string $name}, ${2:UnitEnum $enum}, ${3:Metadata $metadata})",
                    meta: "flow-dsl-entries",
                    score: 1_000,
                    ...
                    name: "enum_schema",
                    caption: "enum_schema",
                    snippet: "enum_schema(${1:string $name}, ${2:string $type}, ${3:bool $nullable}, ${4:Metadata $metadata})",
                    meta: "flow-dsl-schema",
                    score: 1_000,
                    ...
                    name: "equal",
                    caption: "equal",
                    snippet: "equal(${1:Reference|string $left}, ${2:Reference|string $right})",
                    meta: "flow-dsl-comparisons",
                    score: 1_000,
                    ...
                    snippet: "es_hits_to_rows(${1:DocumentDataSource $source})",
                    meta: "flow-dsl-helpers",
                    score: 1_000,
                    ...
                    snippet: "execution_context(${1:Config $config})",
                    meta: "flow-dsl-data-frame",
                    score: 1_000,
                    ...
                    name: "exists",
                    caption: "exists",
                    snippet: "exists(${1:ScalarFunction $ref})",
                    meta: "flow-dsl-scalar-functions",
                    score: 1_000,
                    ...
                    name: "files",
                    caption: "files",
                    snippet: "files(${1:Path|string $directory})",
                    meta: "flow-dsl-extractors",
                    score: 1_000,
                    ...
                    snippet: "filesystem_cache(${1:Path|string|null $cache_dir}, ${2:Filesystem $filesystem}, ${3:Serializer $serializer})",
                    meta: "flow-dsl-data-frame",
                    score: 1_000,
                    ...
                    name: "first",
                    caption: "first",
                    snippet: "first(${1:EntryReference|string $ref})",
                    meta: "flow-dsl-aggregating-functions",
                    score: 1_000,
                    ...
                    name: "float_entry",
                    caption: "float_entry",
                    snippet: "float_entry(${1:string $name}, ${2:string|int|float|null $value}, ${3:Metadata $metadata})",
                    meta: "flow-dsl-entries",
                    score: 1_000,
                    ...
                    snippet: "float_schema(${1:string $name}, ${2:bool $nullable}, ${3:Metadata $metadata})",
                    meta: "flow-dsl-schema",
                    score: 1_000,
                    ...
                    snippet: "flow_context(${1:Config $config})",
                    meta: "flow-dsl-data-frame",
                    score: 1_000,
                    ...
                    name: "from_all",
                    caption: "from_all",
                    snippet: "from_all(${1:Extractor $extractors})",
                    meta: "flow-dsl-extractors",
                    score: 1_000,
                    ...
                    name: "from_array",
                    caption: "from_array",
                    snippet: "from_array(${1:iterable $array}, ${2:Schema $schema})",
                    meta: "flow-dsl-extractors",
                    score: 1_000,
                    ...
                    name: "from_avro",
                    caption: "from_avro",
                    snippet: "from_avro(${1:Path|string $path})",
                    meta: "flow-dsl-extractors",
                    score: 1_000,
                    ...
                    name: "from_cache",
                    caption: "from_cache",
                    snippet: "from_cache(${1:string $id}, ${2:Extractor $fallback_extractor}, ${3:bool $clear})",
                    meta: "flow-dsl-extractors",
                    score: 1_000,
                    ...
                    name: "from_csv",
                    caption: "from_csv",
                    snippet: "from_csv(${1:Path|string $path}, ${2:bool $with_header}, ${3:bool $empty_to_null}, ${4:string $separator}, ${5:string $enclosure}, ${6:string $escape}, ${7:int $characters_read_in_line}, ${8:Schema $schema})",
                    meta: "flow-dsl-extractors",
                    score: 1_000,
                    ...
                    snippet: "from_data_frame(${1:DataFrame $data_frame})",
                    meta: "flow-dsl-extractors",
                    score: 1_000,
                    ...
                    snippet: "from_dbal_key_set_qb(${1:Connection $connection}, ${2:QueryBuilder $queryBuilder}, ${3:KeySet $key_set})",
                    meta: "flow-dsl-extractors",
                    score: 1_000,
                    ...
                    snippet: "from_dbal_limit_offset(${1:Connection $connection}, ${2:Table|string $table}, ${3:OrderBy|array $order_by}, ${4:int $page_size}, ${5:int $maximum})",
                    meta: "flow-dsl-extractors",
                    score: 1_000,
                    ...
                    snippet: "from_dbal_limit_offset_qb(${1:Connection $connection}, ${2:QueryBuilder $queryBuilder}, ${3:int $page_size}, ${4:int $maximum}, ${5:int $offset})",
                    meta: "flow-dsl-extractors",
                    score: 1_000,
                    ...
                    snippet: "from_dbal_queries(${1:Connection $connection}, ${2:string $query}, ${3:ParametersSet $parameters_set}, ${4:array $types})",
                    meta: "flow-dsl-extractors",
                    score: 1_000,
                    ...
                    snippet: "from_dbal_query(${1:Connection $connection}, ${2:string $query}, ${3:array $parameters}, ${4:array $types})",
                    meta: "flow-dsl-extractors",
                    score: 1_000,
                    ...
                    snippet: "from_dynamic_http_requests(${1:ClientInterface $client}, ${2:NextRequestFactory $requestFactory})",
                    meta: "flow-dsl-extractors",
                    score: 1_000,
                    ...
                    name: "from_es",
                    caption: "from_es",
                    snippet: "from_es(${1:array $config}, ${2:array $parameters}, ${3:array $pit_params})",
                    meta: "flow-dsl-extractors",
                    score: 1_000,
                    ...
                    name: "from_excel",
                    caption: "from_excel",
                    snippet: "from_excel(${1:Path|string $path})",
                    meta: "flow-dsl-extractors",
                    score: 1_000,
                    ...
                    snippet: "from_google_sheet(${1:Sheets|array $auth_config}, ${2:string $spreadsheet_id}, ${3:string $sheet_name}, ${4:bool $with_header}, ${5:int $rows_per_page}, ${6:array $options})",
                    meta: "flow-dsl-extractors",
                    score: 1_000,
                    ...
                    snippet: "from_google_sheet_columns(${1:Sheets|array $auth_config}, ${2:string $spreadsheet_id}, ${3:string $sheet_name}, ${4:string $start_range_column}, ${5:string $end_range_column}, ${6:bool $with_header}, ${7:int $rows_per_page}, ${8:array $options})",
                    meta: "flow-dsl-extractors",
                    score: 1_000,
                    ...
                    name: "from_json",
                    caption: "from_json",
                    snippet: "from_json(${1:Path|string $path}, ${2:string $pointer}, ${3:Schema $schema})",
                    meta: "flow-dsl-extractors",
                    score: 1_000,
                    ...
                    snippet: "from_json_lines(${1:Path|string $path})",
                    meta: "flow-dsl-extractors",
                    score: 1_000,
                    ...
                    snippet: "from_meilisearch(${1:array $config}, ${2:array $params}, ${3:string $index})",
                    meta: "flow-dsl-extractors",
                    score: 1_000,
                    ...
                    name: "from_memory",
                    caption: "from_memory",
                    snippet: "from_memory(${1:Memory $memory})",
                    meta: "flow-dsl-extractors",
                    score: 1_000,
                    ...
                    snippet: "from_parquet(${1:Path|string $path}, ${2:array $columns}, ${3:Options $options}, ${4:ByteOrder $byte_order}, ${5:int $offset})",
                    meta: "flow-dsl-extractors",
                    score: 1_000,
                    ...
                    snippet: "from_path_partitions(${1:Path|string $path})",
                    meta: "flow-dsl-extractors",
                    score: 1_000,
                    ...
                    snippet: "from_pipeline(${1:Pipeline $pipeline})",
                    meta: "flow-dsl-extractors",
                    score: 1_000,
                    ...
                    snippet: "from_sequence_date_period(${1:string $entry_name}, ${2:DateTimeInterface $start}, ${3:DateInterval $interval}, ${4:DateTimeInterface $end}, ${5:int $options})",
                    meta: "flow-dsl-extractors",
                    score: 1_000,
                    ...
                    snippet: "from_sequence_date_period_recurrences(${1:string $entry_name}, ${2:DateTimeInterface $start}, ${3:DateInterval $interval}, ${4:int $recurrences}, ${5:int $options})",
                    meta: "flow-dsl-extractors",
                    score: 1_000,
                    ...
                    snippet: "from_sequence_number(${1:string $entry_name}, ${2:string|int|float $start}, ${3:string|int|float $end}, ${4:int|float $step})",
                    meta: "flow-dsl-extractors",
                    score: 1_000,
                    ...
                    snippet: "from_static_http_requests(${1:ClientInterface $client}, ${2:iterable $requests})",
                    meta: "flow-dsl-extractors",
                    score: 1_000,
                    ...
                    name: "from_text",
                    caption: "from_text",
                    snippet: "from_text(${1:Path|string $path})",
                    meta: "flow-dsl-extractors",
                    score: 1_000,
                    ...
                    name: "from_xml",
                    caption: "from_xml",
                    snippet: "from_xml(${1:Path|string $path}, ${2:string $xml_node_path})",
                    meta: "flow-dsl-extractors",
                    score: 1_000,
                    ...
                    name: "fstab",
                    caption: "fstab",
                    snippet: "fstab(${1:Filesystem $filesystems})",
                    meta: "flow-dsl-helpers",
                    score: 1_000,
                    ...
                    snippet: "generate_random_int(${1:int $start}, ${2:int $end}, ${3:NativePHPRandomValueGenerator $generator})",
                    meta: "flow-dsl-data-frame",
                    score: 1_000,
                    ...
                    snippet: "generate_random_string(${1:int $length}, ${2:NativePHPRandomValueGenerator $generator})",
                    meta: "flow-dsl-data-frame",
                    score: 1_000,
                    ...
                    name: "get_type",
                    caption: "get_type",
                    snippet: "get_type(${1:mixed $value})",
                    meta: "flow-dsl-data-frame",
                    score: 1_000,
                    ...
                    name: "greatest",
                    caption: "greatest",
                    snippet: "greatest(${1:mixed $values})",
                    meta: "flow-dsl-scalar-functions",
                    score: 1_000,
                    ...
                    name: "hash",
                    caption: "hash",
                    snippet: "hash(${1:mixed $value}, ${2:Algorithm $algorithm})",
                    meta: "flow-dsl-scalar-functions",
                    score: 1_000,
                    ...
                    snippet: "hash_id_factory(${1:string $entry_names})",
                    meta: "flow-dsl-helpers",
                    score: 1_000,
                    ...
                    name: "html_entry",
                    caption: "html_entry",
                    snippet: "html_entry(${1:string $name}, ${2:HTMLDocument|string|null $value}, ${3:Metadata $metadata})",
                    meta: "flow-dsl-entries",
                    score: 1_000,
                    ...
                    name: "html_schema",
                    caption: "html_schema",
                    snippet: "html_schema(${1:string $name}, ${2:bool $nullable}, ${3:Metadata $metadata})",
                    meta: "flow-dsl-schema",
                    score: 1_000,
                    ...
                    name: "identical",
                    caption: "identical",
                    snippet: "identical(${1:Reference|string $left}, ${2:Reference|string $right})",
                    meta: "flow-dsl-comparisons",
                    score: 1_000,
                    ...
                    snippet: "integer_entry(${1:string $name}, ${2:int $value}, ${3:Metadata $metadata})",
                    meta: "flow-dsl-entries",
                    score: 1_000,
                    ...
                    snippet: "integer_schema(${1:string $name}, ${2:bool $nullable}, ${3:Metadata $metadata})",
                    meta: "flow-dsl-schema",
                    score: 1_000,
                    ...
                    name: "int_entry",
                    caption: "int_entry",
                    snippet: "int_entry(${1:string $name}, ${2:int $value}, ${3:Metadata $metadata})",
                    meta: "flow-dsl-entries",
                    score: 1_000,
                    ...
                    name: "int_schema",
                    caption: "int_schema",
                    snippet: "int_schema(${1:string $name}, ${2:bool $nullable}, ${3:Metadata $metadata})",
                    meta: "flow-dsl-schema",
                    score: 1_000,
                    ...
                    name: "is_type",
                    caption: "is_type",
                    snippet: "is_type(${1:Type|array $type}, ${2:mixed $value})",
                    meta: "flow-dsl-data-frame",
                    score: 1_000,
                    ...
                    snippet: "is_valid_excel_sheet_name(${1:ScalarFunction|string $sheet_name})",
                    meta: "flow-dsl-helpers",
                    score: 1_000,
                    ...
                    name: "join_on",
                    caption: "join_on",
                    snippet: "join_on(${1:Comparison|array $comparisons}, ${2:string $join_prefix})",
                    meta: "flow-dsl-data-frame",
                    score: 1_000,
                    ...
                    name: "json_entry",
                    caption: "json_entry",
                    snippet: "json_entry(${1:string $name}, ${2:array|string|null $data}, ${3:Metadata $metadata})",
                    meta: "flow-dsl-entries",
                    score: 1_000,
                    ...
                    snippet: "json_object_entry(${1:string $name}, ${2:array|string|null $data}, ${3:Metadata $metadata})",
                    meta: "flow-dsl-entries",
                    score: 1_000,
                    ...
                    name: "json_schema",
                    caption: "json_schema",
                    snippet: "json_schema(${1:string $name}, ${2:bool $nullable}, ${3:Metadata $metadata})",
                    meta: "flow-dsl-schema",
                    score: 1_000,
                    ...
                    name: "last",
                    caption: "last",
                    snippet: "last(${1:EntryReference|string $ref})",
                    meta: "flow-dsl-aggregating-functions",
                    score: 1_000,
                    ...
                    name: "line_chart",
                    caption: "line_chart",
                    snippet: "line_chart(${1:EntryReference $label}, ${2:References $datasets})",
                    meta: "flow-dsl-helpers",
                    score: 1_000,
                    ...
                    name: "list_entry",
                    caption: "list_entry",
                    snippet: "list_entry(${1:string $name}, ${2:array $value}, ${3:ListType $type}, ${4:Metadata $metadata})",
                    meta: "flow-dsl-entries",
                    score: 1_000,
                    ...
                    name: "list_ref",
                    caption: "list_ref",
                    snippet: "list_ref(${1:string $entry})",
                    meta: "flow-dsl-scalar-functions",
                    score: 1_000,
                    ...
                    name: "list_schema",
                    caption: "list_schema",
                    snippet: "list_schema(${1:string $name}, ${2:Type $type}, ${3:bool $nullable}, ${4:Metadata $metadata})",
                    meta: "flow-dsl-schema",
                    score: 1_000,
                    ...
                    name: "lower",
                    caption: "lower",
                    snippet: "lower(${1:ScalarFunction|string $value})",
                    meta: "flow-dsl-scalar-functions",
                    score: 1_000,
                    ...
                    name: "map_entry",
                    caption: "map_entry",
                    snippet: "map_entry(${1:string $name}, ${2:array $value}, ${3:Type $mapType}, ${4:Metadata $metadata})",
                    meta: "flow-dsl-entries",
                    score: 1_000,
                    ...
                    name: "map_schema",
                    caption: "map_schema",
                    snippet: "map_schema(${1:string $name}, ${2:Type $type}, ${3:bool $nullable}, ${4:Metadata $metadata})",
                    meta: "flow-dsl-schema",
                    score: 1_000,
                    ...
                    snippet: "mask_columns(${1:array $columns}, ${2:string $mask})",
                    meta: "flow-dsl-transformers",
                    score: 1_000,
                    ...
                    name: "match_cases",
                    caption: "match_cases",
                    snippet: "match_cases(${1:array $cases}, ${2:mixed $default})",
                    meta: "flow-dsl-scalar-functions",
                    score: 1_000,
                    ...
                    snippet: "match_condition(${1:mixed $condition}, ${2:mixed $then})",
                    meta: "flow-dsl-scalar-functions",
                    score: 1_000,
                    ...
                    name: "max",
                    caption: "max",
                    snippet: "max(${1:EntryReference|string $ref})",
                    meta: "flow-dsl-aggregating-functions",
                    score: 1_000,
                    ...
                    snippet: "meilisearch_hits_to_rows()",
                    meta: "flow-dsl-helpers",
                    score: 1_000,
                    ...
                    name: "min",
                    caption: "min",
                    snippet: "min(${1:EntryReference|string $ref})",
                    meta: "flow-dsl-aggregating-functions",
                    score: 1_000,
                    ...
                    snippet: "mysql_insert_options(${1:bool $skip_conflicts}, ${2:bool $upsert}, ${3:array $update_columns})",
                    meta: "flow-dsl-helpers",
                    score: 1_000,
                    ...
                    snippet: "native_local_filesystem()",
                    meta: "flow-dsl-helpers",
                    score: 1_000,
                    ...
                    name: "not",
                    caption: "not",
                    snippet: "not(${1:ScalarFunction $value})",
                    meta: "flow-dsl-scalar-functions",
                    score: 1_000,
                    ...
                    name: "now",
                    caption: "now",
                    snippet: "now(${1:DateTimeZone|ScalarFunction $time_zone})",
                    meta: "flow-dsl-scalar-functions",
                    score: 1_000,
                    ...
                    name: "null_entry",
                    caption: "null_entry",
                    snippet: "null_entry(${1:string $name}, ${2:Metadata $metadata})",
                    meta: "flow-dsl-entries",
                    score: 1_000,
                    ...
                    name: "null_schema",
                    caption: "null_schema",
                    snippet: "null_schema(${1:string $name}, ${2:Metadata $metadata})",
                    meta: "flow-dsl-schema",
                    score: 1_000,
                    ...
                    snippet: "number_format(${1:ScalarFunction|int|float $value}, ${2:ScalarFunction|int $decimals}, ${3:ScalarFunction|string $decimal_separator}, ${4:ScalarFunction|string $thousands_separator})",
                    meta: "flow-dsl-scalar-functions",
                    score: 1_000,
                    ...
                    name: "optional",
                    caption: "optional",
                    snippet: "optional(${1:ScalarFunction $function})",
                    meta: "flow-dsl-scalar-functions",
                    score: 1_000,
                    ...
                    snippet: "pagination_key_asc(${1:string $column}, ${2:ParameterType|Type|string|int $type})",
                    meta: "flow-dsl-helpers",
                    score: 1_000,
                    ...
                    snippet: "pagination_key_desc(${1:string $column}, ${2:ParameterType|Type|string|int $type})",
                    meta: "flow-dsl-helpers",
                    score: 1_000,
                    ...
                    snippet: "pagination_key_set(${1:Key $keys})",
                    meta: "flow-dsl-helpers",
                    score: 1_000,
                    ...
                    name: "partition",
                    caption: "partition",
                    snippet: "partition(${1:string $name}, ${2:string $value})",
                    meta: "flow-dsl-helpers",
                    score: 1_000,
                    ...
                    name: "partitions",
                    caption: "partitions",
                    snippet: "partitions(${1:Partition $partition})",
                    meta: "flow-dsl-helpers",
                    score: 1_000,
                    ...
                    name: "path",
                    caption: "path",
                    snippet: "path(${1:string $path}, ${2:Options|array $options})",
                    meta: "flow-dsl-helpers",
                    score: 1_000,
                    ...
                    name: "path_memory",
                    caption: "path_memory",
                    snippet: "path_memory(${1:string $path}, ${2:array $options})",
                    meta: "flow-dsl-helpers",
                    score: 1_000,
                    ...
                    name: "path_real",
                    caption: "path_real",
                    snippet: "path_real(${1:string $path}, ${2:array $options})",
                    meta: "flow-dsl-helpers",
                    score: 1_000,
                    ...
                    name: "path_stdout",
                    caption: "path_stdout",
                    snippet: "path_stdout(${1:array $options})",
                    meta: "flow-dsl-helpers",
                    score: 1_000,
                    ...
                    name: "pie_chart",
                    caption: "pie_chart",
                    snippet: "pie_chart(${1:EntryReference $label}, ${2:References $datasets})",
                    meta: "flow-dsl-helpers",
                    score: 1_000,
                    ...
                    snippet: "postgresql_insert_options(${1:bool $skip_conflicts}, ${2:string $constraint}, ${3:array $conflict_columns}, ${4:array $update_columns})",
                    meta: "flow-dsl-helpers",
                    score: 1_000,
                    ...
                    snippet: "postgresql_update_options(${1:array $primary_key_columns}, ${2:array $update_columns})",
                    meta: "flow-dsl-helpers",
                    score: 1_000,
                    ...
                    name: "print_rows",
                    caption: "print_rows",
                    snippet: "print_rows(${1:Rows $rows}, ${2:int|bool $truncate}, ${3:Formatter $formatter})",
                    meta: "flow-dsl-data-frame",
                    score: 1_000,
                    ...
                    snippet: "print_schema(${1:Schema $schema}, ${2:SchemaFormatter $formatter})",
                    meta: "flow-dsl-schema",
                    score: 1_000,
                    ...
                    name: "protocol",
                    caption: "protocol",
                    snippet: "protocol(${1:string $protocol})",
                    meta: "flow-dsl-helpers",
                    score: 1_000,
                    ...
                    snippet: "random_string(${1:ScalarFunction|int $length}, ${2:RandomValueGenerator $generator})",
                    meta: "flow-dsl-data-frame",
                    score: 1_000,
                    ...
                    name: "refs",
                    caption: "refs",
                    snippet: "refs(${1:Reference|string $entries})",
                    meta: "flow-dsl-scalar-functions",
                    score: 1_000,
                    ...
                    name: "regex",
                    caption: "regex",
                    snippet: "regex(${1:ScalarFunction|string $pattern}, ${2:ScalarFunction|string $subject}, ${3:ScalarFunction|int $flags}, ${4:ScalarFunction|int $offset})",
                    meta: "flow-dsl-scalar-functions",
                    score: 1_000,
                    ...
                    name: "regex_all",
                    caption: "regex_all",
                    snippet: "regex_all(${1:ScalarFunction|string $pattern}, ${2:ScalarFunction|string $subject}, ${3:ScalarFunction|int $flags}, ${4:ScalarFunction|int $offset})",
                    meta: "flow-dsl-scalar-functions",
                    score: 1_000,
                    ...
                    name: "regex_match",
                    caption: "regex_match",
                    snippet: "regex_match(${1:ScalarFunction|string $pattern}, ${2:ScalarFunction|string $subject}, ${3:ScalarFunction|int $flags}, ${4:ScalarFunction|int $offset})",
                    meta: "flow-dsl-scalar-functions",
                    score: 1_000,
                    ...
                    snippet: "regex_match_all(${1:ScalarFunction|string $pattern}, ${2:ScalarFunction|string $subject}, ${3:ScalarFunction|int $flags}, ${4:ScalarFunction|int $offset})",
                    meta: "flow-dsl-scalar-functions",
                    score: 1_000,
                    ...
                    snippet: "regex_replace(${1:ScalarFunction|string $pattern}, ${2:ScalarFunction|string $replacement}, ${3:ScalarFunction|string $subject}, ${4:ScalarFunction|int|null $limit})",
                    meta: "flow-dsl-scalar-functions",
                    score: 1_000,
                    ...
                    snippet: "rename_replace(${1:array|string $search}, ${2:array|string $replace})",
                    meta: "flow-dsl-transformers",
                    score: 1_000,
                    ...
                    snippet: "rename_style(${1:StringStyles|StringStyles $style})",
                    meta: "flow-dsl-transformers",
                    score: 1_000,
                    ...
                    snippet: "retry_any_throwable(${1:int $limit})",
                    meta: "flow-dsl-helpers",
                    score: 1_000,
                    ...
                    snippet: "retry_on_exception_types(${1:array $exception_types}, ${2:int $limit})",
                    meta: "flow-dsl-helpers",
                    score: 1_000,
                    ...
                    name: "round",
                    caption: "round",
                    snippet: "round(${1:ScalarFunction|int|float $value}, ${2:ScalarFunction|int $precision}, ${3:ScalarFunction|int $mode})",
                    meta: "flow-dsl-scalar-functions",
                    score: 1_000,
                    ...
                    snippet: "rows_partitioned(${1:array $rows}, ${2:Partitions|array $partitions})",
                    meta: "flow-dsl-data-frame",
                    score: 1_000,
                    ...
                    name: "sanitize",
                    caption: "sanitize",
                    snippet: "sanitize(${1:ScalarFunction|string $value}, ${2:ScalarFunction|string $placeholder}, ${3:ScalarFunction|int|null $skipCharacters})",
                    meta: "flow-dsl-scalar-functions",
                    score: 1_000,
                    ...
                    name: "schema",
                    caption: "schema",
                    snippet: "schema(${1:Definition $definitions})",
                    meta: "flow-dsl-schema",
                    score: 1_000,
                    ...
                    snippet: "schema_evolving_validator()",
                    meta: "flow-dsl-helpers",
                    score: 1_000,
                    ...
                    snippet: "schema_from_json(${1:string $schema})",
                    meta: "flow-dsl-helpers",
                    score: 1_000,
                    ...
                    snippet: "schema_from_parquet(${1:Schema $schema})",
                    meta: "flow-dsl-helpers",
                    score: 1_000,
                    ...
                    snippet: "schema_metadata(${1:array $metadata})",
                    meta: "flow-dsl-helpers",
                    score: 1_000,
                    ...
                    snippet: "schema_selective_validator()",
                    meta: "flow-dsl-helpers",
                    score: 1_000,
                    ...
                    snippet: "schema_strict_validator()",
                    meta: "flow-dsl-helpers",
                    score: 1_000,
                    ...
                    snippet: "schema_to_ascii(${1:Schema $schema}, ${2:SchemaFormatter $formatter})",
                    meta: "flow-dsl-helpers",
                    score: 1_000,
                    ...
                    snippet: "schema_to_json(${1:Schema $schema}, ${2:bool $pretty})",
                    meta: "flow-dsl-helpers",
                    score: 1_000,
                    ...
                    snippet: "schema_to_parquet(${1:Schema $schema})",
                    meta: "flow-dsl-helpers",
                    score: 1_000,
                    ...
                    snippet: "schema_to_php(${1:Schema $schema}, ${2:ValueFormatter $valueFormatter}, ${3:TypeFormatter $typeFormatter})",
                    meta: "flow-dsl-helpers",
                    score: 1_000,
                    ...
                    snippet: "schema_validate(${1:Schema $expected}, ${2:Schema $given}, ${3:SchemaValidator $validator})",
                    meta: "flow-dsl-helpers",
                    score: 1_000,
                    ...
                    name: "select",
                    caption: "select",
                    snippet: "select(${1:Reference|string $entries})",
                    meta: "flow-dsl-transformers",
                    score: 1_000,
                    ...
                    name: "split",
                    caption: "split",
                    snippet: "split(${1:ScalarFunction|string $value}, ${2:ScalarFunction|string $separator}, ${3:ScalarFunction|int $limit})",
                    meta: "flow-dsl-scalar-functions",
                    score: 1_000,
                    ...
                    name: "sprintf",
                    caption: "sprintf",
                    snippet: "sprintf(${1:ScalarFunction|string $format}, ${2:ScalarFunction|string|int|float|null $args})",
                    meta: "flow-dsl-scalar-functions",
                    score: 1_000,
                    ...
                    snippet: "sqlite_insert_options(${1:bool $skip_conflicts}, ${2:array $conflict_columns}, ${3:array $update_columns})",
                    meta: "flow-dsl-helpers",
                    score: 1_000,
                    ...
                    name: "string_agg",
                    caption: "string_agg",
                    snippet: "string_agg(${1:EntryReference|string $ref}, ${2:string $separator}, ${3:SortOrder $sort})",
                    meta: "flow-dsl-aggregating-functions",
                    score: 1_000,
                    ...
                    snippet: "string_entry(${1:string $name}, ${2:string $value}, ${3:Metadata $metadata})",
                    meta: "flow-dsl-entries",
                    score: 1_000,
                    ...
                    snippet: "string_schema(${1:string $name}, ${2:bool $nullable}, ${3:Metadata $metadata})",
                    meta: "flow-dsl-schema",
                    score: 1_000,
                    ...
                    snippet: "structure_entry(${1:string $name}, ${2:array $value}, ${3:Type $type}, ${4:Metadata $metadata})",
                    meta: "flow-dsl-entries",
                    score: 1_000,
                    ...
                    snippet: "structure_ref(${1:string $entry})",
                    meta: "flow-dsl-scalar-functions",
                    score: 1_000,
                    ...
                    snippet: "structure_schema(${1:string $name}, ${2:Type $type}, ${3:bool $nullable}, ${4:Metadata $metadata})",
                    meta: "flow-dsl-schema",
                    score: 1_000,
                    ...
                    snippet: "struct_entry(${1:string $name}, ${2:array $value}, ${3:Type $type}, ${4:Metadata $metadata})",
                    meta: "flow-dsl-entries",
                    score: 1_000,
                    ...
                    snippet: "struct_schema(${1:string $name}, ${2:Type $type}, ${3:bool $nullable}, ${4:Metadata $metadata})",
                    meta: "flow-dsl-schema",
                    score: 1_000,
                    ...
                    name: "str_entry",
                    caption: "str_entry",
                    snippet: "str_entry(${1:string $name}, ${2:string $value}, ${3:Metadata $metadata})",
                    meta: "flow-dsl-entries",
                    score: 1_000,
                    ...
                    name: "str_schema",
                    caption: "str_schema",
                    snippet: "str_schema(${1:string $name}, ${2:bool $nullable}, ${3:Metadata $metadata})",
                    meta: "flow-dsl-schema",
                    score: 1_000,
                    ...
                    name: "sum",
                    caption: "sum",
                    snippet: "sum(${1:EntryReference|string $ref})",
                    meta: "flow-dsl-aggregating-functions",
                    score: 1_000,
                    ...
                    snippet: "table_schema_to_flow_schema(${1:Table $table}, ${2:array $types_map})",
                    meta: "flow-dsl-helpers",
                    score: 1_000,
                    ...
                    name: "time_entry",
                    caption: "time_entry",
                    snippet: "time_entry(${1:string $name}, ${2:DateInterval|string|null $value}, ${3:Metadata $metadata})",
                    meta: "flow-dsl-entries",
                    score: 1_000,
                    ...
                    name: "time_schema",
                    caption: "time_schema",
                    snippet: "time_schema(${1:string $name}, ${2:bool $nullable}, ${3:Metadata $metadata})",
                    meta: "flow-dsl-schema",
                    score: 1_000,
                    ...
                    name: "to_array",
                    caption: "to_array",
                    snippet: "to_array(${1:array $array})",
                    ...
                    name: "to_avro",
                    caption: "to_avro",
                    snippet: "to_avro(${1:Path|string $path}, ${2:Schema $schema})",
                    meta: "flow-dsl-loaders",
                    score: 1_000,
                    ...
                    name: "to_branch",
                    caption: "to_branch",
                    snippet: "to_branch(${1:ScalarFunction $condition}, ${2:Loader $loader})",
                    meta: "flow-dsl-loaders",
                    score: 1_000,
                    ...
                    name: "to_callable",
                    caption: "to_callable",
                    snippet: "to_callable(${1:callable $callable})",
                    meta: "flow-dsl-loaders",
                    score: 1_000,
                    ...
                    name: "to_chartjs",
                    caption: "to_chartjs",
                    snippet: "to_chartjs(${1:Chart $type})",
                    meta: "flow-dsl-loaders",
                    score: 1_000,
                    ...
                    snippet: "to_chartjs_file(${1:Chart $type}, ${2:Path|string|null $output}, ${3:Path|string|null $template})",
                    meta: "flow-dsl-loaders",
                    score: 1_000,
                    ...
                    snippet: "to_chartjs_var(${1:Chart $type}, ${2:array $output})",
                    meta: "flow-dsl-loaders",
                    score: 1_000,
                    ...
                    name: "to_csv",
                    caption: "to_csv",
                    snippet: "to_csv(${1:Path|string $uri}, ${2:bool $with_header}, ${3:string $separator}, ${4:string $enclosure}, ${5:string $escape}, ${6:string $new_line_separator}, ${7:string $datetime_format})",
                    meta: "flow-dsl-loaders",
                    score: 1_000,
                    ...
                    name: "to_date",
                    caption: "to_date",
                    snippet: "to_date(${1:mixed $ref}, ${2:ScalarFunction|string $format}, ${3:ScalarFunction|DateTimeZone $timeZone})",
                    meta: "flow-dsl-scalar-functions",
                    score: 1_000,
                    ...
                    snippet: "to_date_time(${1:mixed $ref}, ${2:ScalarFunction|string $format}, ${3:ScalarFunction|DateTimeZone $timeZone})",
                    meta: "flow-dsl-scalar-functions",
                    score: 1_000,
                    ...
                    snippet: "to_dbal_schema_table(${1:Schema $schema}, ${2:string $table_name}, ${3:array $table_options}, ${4:array $types_map})",
                    meta: "flow-dsl-helpers",
                    score: 1_000,
                    ...
                    snippet: "to_dbal_table_delete(${1:Connection|array $connection}, ${2:string $table})",
                    meta: "flow-dsl-loaders",
                    score: 1_000,
                    ...
                    snippet: "to_dbal_table_insert(${1:Connection|array $connection}, ${2:string $table}, ${3:InsertOptions $options})",
                    meta: "flow-dsl-loaders",
                    score: 1_000,
                    ...
                    snippet: "to_dbal_table_update(${1:Connection|array $connection}, ${2:string $table}, ${3:UpdateOptions $options})",
                    meta: "flow-dsl-loaders",
                    score: 1_000,
                    ...
                    snippet: "to_dbal_transaction(${1:Connection|array $connection}, ${2:Loader $loaders})",
                    meta: "flow-dsl-loaders",
                    score: 1_000,
                    ...
                    name: "to_entry",
                    caption: "to_entry",
                    snippet: "to_entry(${1:string $name}, ${2:mixed $data}, ${3:EntryFactory $entryFactory})",
                    meta: "flow-dsl-data-frame",
                    score: 1_000,
                    ...
                    snippet: "to_es_bulk_index(${1:array $config}, ${2:string $index}, ${3:IdFactory $id_factory}, ${4:array $parameters})",
                    meta: "flow-dsl-loaders",
                    score: 1_000,
                    ...
                    snippet: "to_es_bulk_update(${1:array $config}, ${2:string $index}, ${3:IdFactory $id_factory}, ${4:array $parameters})",
                    meta: "flow-dsl-loaders",
                    score: 1_000,
                    ...
                    name: "to_json",
                    caption: "to_json",
                    snippet: "to_json(${1:Path|string $path}, ${2:int $flags}, ${3:string $date_time_format}, ${4:bool $put_rows_in_new_lines})",
                    meta: "flow-dsl-loaders",
                    score: 1_000,
                    ...
                    snippet: "to_json_lines(${1:Path|string $path})",
                    meta: "flow-dsl-loaders",
                    score: 1_000,
                    ...
                    snippet: "to_meilisearch_bulk_index(${1:array $config}, ${2:string $index})",
                    meta: "flow-dsl-loaders",
                    score: 1_000,
                    ...
                    snippet: "to_meilisearch_bulk_update(${1:array $config}, ${2:string $index})",
                    meta: "flow-dsl-loaders",
                    score: 1_000,
                    ...
                    name: "to_memory",
                    caption: "to_memory",
                    snippet: "to_memory(${1:Memory $memory})",
                    meta: "flow-dsl-loaders",
                    score: 1_000,
                    ...
                    name: "to_output",
                    caption: "to_output",
                    snippet: "to_output(${1:int|bool $truncate}, ${2:Output $output}, ${3:Formatter $formatter}, ${4:SchemaFormatter $schemaFormatter})",
                    meta: "flow-dsl-loaders",
                    score: 1_000,
                    ...
                    name: "to_parquet",
                    caption: "to_parquet",
                    snippet: "to_parquet(${1:Path|string $path}, ${2:Options $options}, ${3:Compressions $compressions}, ${4:Schema $schema})",
                    meta: "flow-dsl-loaders",
                    score: 1_000,
                    ...
                    name: "to_stderr",
                    caption: "to_stderr",
                    snippet: "to_stderr(${1:int|bool $truncate}, ${2:Output $output}, ${3:Formatter $formatter}, ${4:SchemaFormatter $schemaFormatter})",
                    meta: "flow-dsl-loaders",
                    score: 1_000,
                    ...
                    name: "to_stdout",
                    caption: "to_stdout",
                    snippet: "to_stdout(${1:int|bool $truncate}, ${2:Output $output}, ${3:Formatter $formatter}, ${4:SchemaFormatter $schemaFormatter})",
                    meta: "flow-dsl-loaders",
                    score: 1_000,
                    ...
                    name: "to_stream",
                    caption: "to_stream",
                    snippet: "to_stream(${1:string $uri}, ${2:int|bool $truncate}, ${3:Output $output}, ${4:string $mode}, ${5:Formatter $formatter}, ${6:SchemaFormatter $schemaFormatter})",
                    meta: "flow-dsl-loaders",
                    score: 1_000,
                    ...
                    name: "to_text",
                    caption: "to_text",
                    snippet: "to_text(${1:Path|string $path}, ${2:string $new_line_separator})",
                    meta: "flow-dsl-loaders",
                    score: 1_000,
                    ...
                    name: "to_timezone",
                    caption: "to_timezone",
                    snippet: "to_timezone(${1:ScalarFunction|DateTimeInterface $value}, ${2:ScalarFunction|DateTimeZone|string $timeZone})",
                    meta: "flow-dsl-scalar-functions",
                    score: 1_000,
                    ...
                    snippet: "to_transformation(${1:Transformer|Transformation $transformer}, ${2:Loader $loader})",
                    meta: "flow-dsl-loaders",
                    score: 1_000,
                    ...
                    name: "to_xml",
                    caption: "to_xml",
                    snippet: "to_xml(${1:Path|string $path}, ${2:string $root_element_name}, ${3:string $row_element_name}, ${4:string $attribute_prefix}, ${5:string $date_time_format}, ${6:XMLWriter $xml_writer})",
                    meta: "flow-dsl-loaders",
                    score: 1_000,
                    ...
                    snippet: "type_class_string(${1:string $class})",
                    meta: "flow-dsl-type",
                    score: 1_000,
                    ...
                    name: "type_enum",
                    caption: "type_enum",
                    snippet: "type_enum(${1:string $class})",
                    meta: "flow-dsl-type",
                    score: 1_000,
                    ...
                    name: "type_equals",
                    caption: "type_equals",
                    snippet: "type_equals(${1:Type $left}, ${2:Type $right})",
                    meta: "flow-dsl-helpers",
                    score: 1_000,
                    ...
                    snippet: "type_from_array(${1:array $data})",
                    meta: "flow-dsl-helpers",
                    score: 1_000,
                    ...
                    snippet: "type_instance_of(${1:string $class})",
                    meta: "flow-dsl-type",
                    score: 1_000,
                    ...
                    snippet: "type_intersection(${1:Type $first}, ${2:Type $second}, ${3:Type $types})",
                    meta: "flow-dsl-type",
                    score: 1_000,
                    ...
                    name: "type_is",
                    caption: "type_is",
                    snippet: "type_is(${1:Type $type}, ${2:string $typeClass})",
                    meta: "flow-dsl-helpers",
                    score: 1_000,
                    ...
                    name: "type_is_any",
                    caption: "type_is_any",
                    snippet: "type_is_any(${1:Type $type}, ${2:string $typeClass}, ${3:string $typeClasses})",
                    meta: "flow-dsl-helpers",
                    score: 1_000,
                    ...
                    snippet: "type_is_nullable(${1:Type $type})",
                    meta: "flow-dsl-helpers",
                    score: 1_000,
                    ...
                    name: "type_list",
                    caption: "type_list",
                    snippet: "type_list(${1:Type $element})",
                    meta: "flow-dsl-type",
                    score: 1_000,
                    ...
                    snippet: "type_literal(${1:string|int|float|bool $value})",
                    meta: "flow-dsl-type",
                    score: 1_000,
                    ...
                    name: "type_map",
                    caption: "type_map",
                    snippet: "type_map(${1:Type $key_type}, ${2:Type $value_type})",
                    meta: "flow-dsl-type",
                    score: 1_000,
                    ...
                    snippet: "type_optional(${1:Type $type})",
                    meta: "flow-dsl-type",
                    score: 1_000,
                    ...
                    snippet: "type_structure(${1:array $elements}, ${2:array $optional_elements}, ${3:bool $allow_extra})",
                    meta: "flow-dsl-type",
                    score: 1_000,
                    ...
                    name: "type_union",
                    caption: "type_union",
                    snippet: "type_union(${1:Type $first}, ${2:Type $second}, ${3:Type $types})",
                    meta: "flow-dsl-type",
                    score: 1_000,
                    ...
                    name: "ulid",
                    caption: "ulid",
                    snippet: "ulid(${1:ScalarFunction|string|null $value})",
                    meta: "flow-dsl-scalar-functions",
                    score: 1_000,
                    ...
                    name: "upper",
                    caption: "upper",
                    snippet: "upper(${1:ScalarFunction|string $value})",
                    meta: "flow-dsl-scalar-functions",
                    score: 1_000,
                    ...
                    name: "uuid_entry",
                    caption: "uuid_entry",
                    snippet: "uuid_entry(${1:string $name}, ${2:Uuid|string|null $value}, ${3:Metadata $metadata})",
                    meta: "flow-dsl-entries",
                    score: 1_000,
                    ...
                    name: "uuid_schema",
                    caption: "uuid_schema",
                    snippet: "uuid_schema(${1:string $name}, ${2:bool $nullable}, ${3:Metadata $metadata})",
                    meta: "flow-dsl-schema",
                    score: 1_000,
                    ...
                    name: "uuid_v7",
                    caption: "uuid_v7",
                    snippet: "uuid_v7(${1:ScalarFunction|DateTimeInterface|null $value})",
                    meta: "flow-dsl-scalar-functions",
                    score: 1_000,
                    ...
                    name: "when",
                    caption: "when",
                    snippet: "when(${1:mixed $condition}, ${2:mixed $then}, ${3:mixed $else})",
                    meta: "flow-dsl-scalar-functions",
                    score: 1_000,
                    ...
                    name: "with_entry",
                    caption: "with_entry",
                    snippet: "with_entry(${1:string $name}, ${2:ScalarFunction $function})",
                    meta: "flow-dsl-helpers",
                    score: 1_000,
                    ...
                    snippet: "write_with_retries(${1:Loader $loader}, ${2:RetryStrategy $retry_strategy}, ${3:DelayFactory $delay_factory}, ${4:Sleep $sleep})",
                    meta: "flow-dsl-loaders",
                    score: 1_000,
                    ...
                    snippet: "xml_element_entry(${1:string $name}, ${2:DOMElement|string|null $value}, ${3:Metadata $metadata})",
                    meta: "flow-dsl-entries",
                    score: 1_000,
                    ...
                    snippet: "xml_element_schema(${1:string $name}, ${2:bool $nullable}, ${3:Metadata $metadata})",
                    meta: "flow-dsl-schema",
                    score: 1_000,
                    ...
                    name: "xml_entry",
                    caption: "xml_entry",
                    snippet: "xml_entry(${1:string $name}, ${2:DOMDocument|string|null $value}, ${3:Metadata $metadata})",
                    meta: "flow-dsl-entries",
                    score: 1_000,
                    ...
                    name: "xml_schema",
                    caption: "xml_schema",
                    snippet: "xml_schema(${1:string $name}, ${2:bool $nullable}, ${3:Metadata $metadata})",
                    meta: "flow-dsl-schema",
                    score: 1_000,
