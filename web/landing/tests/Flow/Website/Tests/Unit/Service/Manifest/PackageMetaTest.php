...
use Flow\Website\Service\Manifest\{Manifest, PackageMeta};
...
final class PackageMetaTest extends TestCase
{
    ...
    public function test_etl_package_uses_core_label_override() : void
    {
        ...
        self::assertSame(
            ['type' => 'Core', 'component' => 'Core'],
            $meta->forPackage('flow-php/etl'),
        );
    }
    ...
    public function test_for_dsl_module_returns_label(string $module, string $expected) : void
    {
        ...
        self::assertSame($expected, $meta->forDslModule($module));
    }
    ...
    public function test_for_dsl_module_returns_null_for_unknown_module() : void
    {
        ...
        self::assertNull($meta->forDslModule('not-a-module'));
    }
    ...
    public function test_for_package_returns_expected_label(string $name, string $type, string $expectedType, string $expectedComponent) : void
    {
        $meta = $this->buildMeta([
        ...
        self::assertSame(
            ['type' => $expectedType, 'component' => $expectedComponent],
            $meta->forPackage($name),
        );
    }
    ...
    public function test_for_package_returns_null_for_unknown_package() : void
    {
        ...
        self::assertNull($meta->forPackage('flow-php/missing'));
    }
    ...
    public function test_for_package_returns_null_for_unknown_type() : void
    {
        ...
        self::assertNull($meta->forPackage('flow-php/wat'));
    }
}
