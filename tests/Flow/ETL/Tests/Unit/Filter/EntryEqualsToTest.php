...
final class EntryEqualsToTest extends TestCase
{
    public function test_float_entry_equals_float() : void
    {
        ...
        $this->assertFalse($filter->keep(Row::create(Entry::string('float-entry', 'test'))));
    }
    ...
    public function test_float_entry_equals_to_integer() : void
    {
        ...
        $this->assertTrue($filter->keep(Row::create(Entry::integer('float-entry', 10))));
    }
    ...
    public function test_float_entry_equals_to_numeric() : void
    {
        ...
        $this->assertTrue($filter->keep(Row::create(Entry::string('float-entry', '10.01'))));
    }
    ...
    public function test_float_entry_not_equals() : void
    {
        ...
        $this->assertTrue($filter->keep(Row::create(Entry::float('float-entry', 1.0001003))));
        $this->assertFalse($filter->keep(Row::create(Entry::float('float-entry', 1.0002003))));
    }
    ...
    public function test_that_entry_is_not_a_string() : void
    {
        ...
        $this->assertFalse($filter->keep(Row::create(Entry::json('test-entry', []))));
    }
    ...
    public function test_that_integer_entry_is_equals_to_other_integer() : void
    {
        ...
        $this->assertFalse($filter->keep(Row::create(Entry::integer('integer-entry', 404))));
        $this->assertTrue($filter->keep(Row::create(Entry::integer('integer-entry', 200))));
    }
    ...
    public function test_that_string_entry_is_not_equals_to() : void
    {
        ...
        $this->assertFalse($filter->keep(Row::create(Entry::string_lower('test-entry', 'test-value-random'))));
    }
}
