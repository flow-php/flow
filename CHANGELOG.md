...
### Security
- [#2650](https://github.com/flow-php/flow/pull/2650) - **flow-php/arrow-ext - resolved thrift excessive memory allocation advisory** - [@norberttech](https://github.com/norberttech)
- [#2650](https://github.com/flow-php/flow/pull/2650) - **Flow PHP - bumped league/commonmark to 2.10.3 on the landing site** - [@norberttech](https://github.com/norberttech)
...
- [#2620](https://github.com/flow-php/flow/pull/2620) - **flow-php/etl - Scalar, aggregate and window functions declare their return type** - [@norberttech](https://github.com/norberttech)
- [#2620](https://github.com/flow-php/flow/pull/2620) - **flow-php/etl - Comparison predicates follow SQL three-valued logic** - [@norberttech](https://github.com/norberttech)
- [#2620](https://github.com/flow-php/flow/pull/2620) - **flow-php/etl - PartitioningLoader and RepartitionProcessor for partitioned writes** - [@norberttech](https://github.com/norberttech)
- [#2620](https://github.com/flow-php/flow/pull/2620) - **flow-php/etl - Parquet and Floe discover Hive partitions on read** - [@norberttech](https://github.com/norberttech)
- [#2620](https://github.com/flow-php/flow/pull/2620) - **flow-php/etl - Extractors yield batches up to withBatchSize()** - [@norberttech](https://github.com/norberttech)
- [#2620](https://github.com/flow-php/flow/pull/2620) - **flow-php/etl - limit() is pushed down into the source through LimitPushDown** - [@norberttech](https://github.com/norberttech)
- [#2620](https://github.com/flow-php/flow/pull/2620) - **flow-php/etl - ErrorHandler answers separately for extraction, transformation and loading** - [@norberttech](https://github.com/norberttech)
- [#2620](https://github.com/flow-php/flow/pull/2620) - **flow-php/etl - Every governed operation can override its algorithm** - [@norberttech](https://github.com/norberttech)
- [#2620](https://github.com/flow-php/flow/pull/2620) - **flow-php/etl - FilesSink discards partial output from a failed run** - [@norberttech](https://github.com/norberttech)
- [#2620](https://github.com/flow-php/flow/pull/2620) - **flow-php/etl - Cache::schema() stores the schema beside the cached rows** - [@norberttech](https://github.com/norberttech)
- [#2620](https://github.com/flow-php/flow/pull/2620) - **flow-php/etl - Rows::trusted() skips validation for rows the engine produced** - [@norberttech](https://github.com/norberttech)
- [#2620](https://github.com/flow-php/flow/pull/2620) - **flow-php/etl - Schema::conformOrderTo() reorders a schema to match another** - [@norberttech](https://github.com/norberttech)
- [#2620](https://github.com/flow-php/flow/pull/2620) - **flow-php/etl-adapter-csv - inferSchema() plus CSVReadOptions, CSVDialect and CSVHeader** - [@norberttech](https://github.com/norberttech)
- [#2620](https://github.com/flow-php/flow/pull/2620) - **flow-php/etl-adapter-json - JSON sources infer their schema through inferSchema()** - [@norberttech](https://github.com/norberttech)
- [#2620](https://github.com/flow-php/flow/pull/2620) - **flow-php/etl-adapter-excel - Excel sources infer their schema through inferSchema()** - [@norberttech](https://github.com/norberttech)
- [#2620](https://github.com/flow-php/flow/pull/2620) - **flow-php/etl-adapter-google-sheet - Google Sheet sources infer their schema, with a withEmptyToNull() option** - [@norberttech](https://github.com/norberttech)
- [#2620](https://github.com/flow-php/flow/pull/2620) - **flow-php/etl-adapter-doctrine - DBAL sources derive their schema from the query result** - [@norberttech](https://github.com/norberttech)
- [#2620](https://github.com/flow-php/flow/pull/2620) - **flow-php/etl-adapter-postgresql - PostgreSQL sources derive their schema from a zero-row probe** - [@norberttech](https://github.com/norberttech)
- [#2620](https://github.com/flow-php/flow/pull/2620) - **flow-php/etl-adapter-xml - StringXMLWriter is the default XML writer** - [@norberttech](https://github.com/norberttech)
- [#2620](https://github.com/flow-php/flow/pull/2620) - **flow-php/postgresql - Client::describe() reports a query's result columns** - [@norberttech](https://github.com/norberttech)
- [#2620](https://github.com/flow-php/flow/pull/2620) - **flow-php/postgresql - ResultCaster handles array, oid and timetz** - [@norberttech](https://github.com/norberttech)
- [#2620](https://github.com/flow-php/flow/pull/2620) - **flow-php/types - structure_element(), type_bare(), PromotingUnifier and StrictUnifier** - [@norberttech](https://github.com/norberttech)
- [#2620](https://github.com/flow-php/flow/pull/2620) - **flow-php/doctrine-dbal-bulk - Bulk writes split at the database's bind-parameter limit** - [@norberttech](https://github.com/norberttech)
- [#2620](https://github.com/flow-php/flow/pull/2620) - **flow-php/filesystem - Filesystem::supports() and FileListing** - [@norberttech](https://github.com/norberttech)
- [#2620](https://github.com/flow-php/flow/pull/2620) - **flow-php/mago-types-bridge - New package that derives structure shapes for the Mago analyzer** - [@norberttech](https://github.com/norberttech)
...
- [#2620](https://github.com/flow-php/flow/pull/2620) - **flow-php/etl - Transformer and Processor require bind()** - [@norberttech](https://github.com/norberttech)
- [#2620](https://github.com/flow-php/flow/pull/2620) - **flow-php/etl - Expressions and steps are checked before the first row is read** - [@norberttech](https://github.com/norberttech)
- [#2620](https://github.com/flow-php/flow/pull/2620) - **flow-php/etl - A function given bad data throws; optional() is the only way to tolerate it** - [@norberttech](https://github.com/norberttech)
- [#2620](https://github.com/flow-php/flow/pull/2620) - **flow-php/etl - equals() and notEquals() return null when either side is null** - [@norberttech](https://github.com/norberttech)
- [#2620](https://github.com/flow-php/flow/pull/2620) - **flow-php/etl - EntryReference is split into immutable UnresolvedReference and ResolvedReference** - [@norberttech](https://github.com/norberttech)
- [#2620](https://github.com/flow-php/flow/pull/2620) - **flow-php/etl - Window and window functions are immutable** - [@norberttech](https://github.com/norberttech)
- [#2620](https://github.com/flow-php/flow/pull/2620) - **flow-php/etl - call() takes a ScalarFunction and a return type** - [@norberttech](https://github.com/norberttech)
- [#2620](https://github.com/flow-php/flow/pull/2620) - **flow-php/etl - Hydrator, array_to_row() and array_to_rows() require a Schema** - [@norberttech](https://github.com/norberttech)
- [#2620](https://github.com/flow-php/flow/pull/2620) - **flow-php/etl - pivot() takes its values, unpack() takes the schema it produces** - [@norberttech](https://github.com/norberttech)
- [#2620](https://github.com/flow-php/flow/pull/2620) - **flow-php/etl - divide() always returns float** - [@norberttech](https://github.com/norberttech)
- [#2620](https://github.com/flow-php/flow/pull/2620) - **flow-php/etl - File sources and sinks take a Filesystem; the mount table leaves Config** - [@norberttech](https://github.com/norberttech)
- [#2620](https://github.com/flow-php/flow/pull/2620) - **flow-php/etl - Spilling algorithms take a BucketsStorage** - [@norberttech](https://github.com/norberttech)
- [#2620](https://github.com/flow-php/flow/pull/2620) - **flow-php/etl - Save mode moves from DataFrame to FileLoader** - [@norberttech](https://github.com/norberttech)
- [#2620](https://github.com/flow-php/flow/pull/2620) - **flow-php/etl - Partitioning happens in loaders, and partition columns are removed from file bodies** - [@norberttech](https://github.com/norberttech)
- [#2620](https://github.com/flow-php/flow/pull/2620) - **flow-php/etl - Floe format v2 rejects values that contradict the file schema** - [@norberttech](https://github.com/norberttech)
- [#2620](https://github.com/flow-php/flow/pull/2620) - **flow-php/etl - A failed cast throws SchemaMismatchException naming the column and row** - [@norberttech](https://github.com/norberttech)
- [#2620](https://github.com/flow-php/flow/pull/2620) - **flow-php/etl - Config options move to the extractors** - [@norberttech](https://github.com/norberttech)
- [#2620](https://github.com/flow-php/flow/pull/2620) - **flow-php/etl - RetryLoader no longer retries InvalidLogicException by default** - [@norberttech](https://github.com/norberttech)
- [#2620](https://github.com/flow-php/flow/pull/2620) - **flow-php/etl - DSL documentation attributes move to the documentation tool** - [@norberttech](https://github.com/norberttech)
- [#2620](https://github.com/flow-php/flow/pull/2620) - **flow-php/types - StructureType holds an ordered list of StructureElement** - [@norberttech](https://github.com/norberttech)
- [#2620](https://github.com/flow-php/flow/pull/2620) - **flow-php/types - Type::cast() refuses values it used to coerce** - [@norberttech](https://github.com/norberttech)
- [#2620](https://github.com/flow-php/flow/pull/2620) - **flow-php/types - TypeMerge moves from flow-php/etl as TypeWidener** - [@norberttech](https://github.com/norberttech)
- [#2620](https://github.com/flow-php/flow/pull/2620) - **flow-php/types - detectType() returns different types for arrays** - [@norberttech](https://github.com/norberttech)
- [#2620](https://github.com/flow-php/flow/pull/2620) - **flow-php/types - Digit-only and month-only strings are no longer inferred as dates** - [@norberttech](https://github.com/norberttech)
- [#2620](https://github.com/flow-php/flow/pull/2620) - **flow-php/filesystem - Partition takes a value and its type, and accepts null** - [@norberttech](https://github.com/norberttech)
- [#2620](https://github.com/flow-php/flow/pull/2620) - **flow-php/filesystem - readLines() strips the separator and yields nothing for 0 bytes** - [@norberttech](https://github.com/norberttech)
- [#2620](https://github.com/flow-php/flow/pull/2620) - **flow-php/postgresql - execute() accepts ConvertedParameters** - [@norberttech](https://github.com/norberttech)
- [#2620](https://github.com/flow-php/flow/pull/2620) - **flow-php/postgresql - oid is cast to integer, and duplicate columns are cast by name** - [@norberttech](https://github.com/norberttech)
- [#2620](https://github.com/flow-php/flow/pull/2620) - **flow-php/doctrine-dbal-bulk - Dialect requires maxBindParameters()** - [@norberttech](https://github.com/norberttech)
- [#2620](https://github.com/flow-php/flow/pull/2620) - **flow-php/etl-adapter-csv - Cells are read as typed values instead of strings** - [@norberttech](https://github.com/norberttech)
- [#2620](https://github.com/flow-php/flow/pull/2620) - **flow-php/etl-adapter-json - to_json() writes containers as nested JSON** - [@norberttech](https://github.com/norberttech)
- [#2620](https://github.com/flow-php/flow/pull/2620) - **flow-php/etl-adapter-json - Keys outside the inference sample are dropped** - [@norberttech](https://github.com/norberttech)
- [#2620](https://github.com/flow-php/flow/pull/2620) - **flow-php/etl-adapter-excel - Text cells narrow to uuid, json and timezone** - [@norberttech](https://github.com/norberttech)
- [#2620](https://github.com/flow-php/flow/pull/2620) - **flow-php/etl-adapter-excel - to_excel() writes real date cells** - [@norberttech](https://github.com/norberttech)
- [#2620](https://github.com/flow-php/flow/pull/2620) - **flow-php/etl-adapter-excel - Requires openspout/openspout ~5.3.0** - [@norberttech](https://github.com/norberttech)
- [#2620](https://github.com/flow-php/flow/pull/2620) - **flow-php/etl-adapter-google-sheet - Cells are typed, and an empty cell reads as null** - [@norberttech](https://github.com/norberttech)
- [#2620](https://github.com/flow-php/flow/pull/2620) - **flow-php/etl-adapter-http - response_body and request_body hold the raw body text** - [@norberttech](https://github.com/norberttech)
- [#2620](https://github.com/flow-php/flow/pull/2620) - **flow-php/etl-adapter-xml - from_xml() reads with XMLReader and keeps each element as written** - [@norberttech](https://github.com/norberttech)
- [#2620](https://github.com/flow-php/flow/pull/2620) - **flow-php/etl-adapter-parquet - Globs check every file against the first; unionByName() reads them as one schema** - [@norberttech](https://github.com/norberttech)
- [#2620](https://github.com/flow-php/flow/pull/2620) - **flow-php/etl-adapter-doctrine - from_dbal_*() takes column types from the query** - [@norberttech](https://github.com/norberttech)
- [#2620](https://github.com/flow-php/flow/pull/2620) - **flow-php/etl-adapter-doctrine - withPageSize() becomes withBatchSize()** - [@norberttech](https://github.com/norberttech)
- [#2620](https://github.com/flow-php/flow/pull/2620) - **flow-php/etl-adapter-doctrine - Transactional loaders run closure() inside the transaction** - [@norberttech](https://github.com/norberttech)
- [#2620](https://github.com/flow-php/flow/pull/2620) - **flow-php/etl-adapter-postgresql - from_pgsql_*() takes column types from the query** - [@norberttech](https://github.com/norberttech)
- [#2620](https://github.com/flow-php/flow/pull/2620) - **flow-php/etl-adapter-postgresql - withFetchSize() becomes withBatchSize()** - [@norberttech](https://github.com/norberttech)
- [#2620](https://github.com/flow-php/flow/pull/2620) - **flow-php/etl-adapter-text - from_text() and to_text() take a Filesystem** - [@norberttech](https://github.com/norberttech)
- [#2620](https://github.com/flow-php/flow/pull/2620) - **flow-php/etl-adapter-avro - from_avro() and to_avro() take a Filesystem** - [@norberttech](https://github.com/norberttech)
- [#2620](https://github.com/flow-php/flow/pull/2620) - **flow-php/etl-adapter-chartjs - to_chartjs_file() takes a Filesystem** - [@norberttech](https://github.com/norberttech)
- [#2620](https://github.com/flow-php/flow/pull/2620) - **flow-php/etl-adapter-chartjs - Chart functions accept any Reference** - [@norberttech](https://github.com/norberttech)
- [#2620](https://github.com/flow-php/flow/pull/2620) - **flow-php/symfony-http-foundation-bridge - Output::loader() takes a Filesystem** - [@norberttech](https://github.com/norberttech)
- [#2620](https://github.com/flow-php/flow/pull/2620) - **flow-php/cli - --schema-auto-cast is replaced by schema inference flags** - [@norberttech](https://github.com/norberttech)
- [#2620](https://github.com/flow-php/flow/pull/2620) - **flow-php/cli - Command classes name themselves with #[AsCommand]** - [@norberttech](https://github.com/norberttech)
- [#2620](https://github.com/flow-php/flow/pull/2620) - **flow-php/flow-php-ext - Native hydrator and structure_v2 wire shape; the extension must be reinstalled** - [@norberttech](https://github.com/norberttech)
...
- [#2620](https://github.com/flow-php/flow/pull/2620) - **flow-php/etl - pivot() works with min, max, first, last and collect** - [@norberttech](https://github.com/norberttech)
- [#2620](https://github.com/flow-php/flow/pull/2620) - **flow-php/etl - SkipRows skips the failed batch instead of emitting it half transformed** - [@norberttech](https://github.com/norberttech)
- [#2620](https://github.com/flow-php/flow/pull/2620) - **flow-php/etl - until() stops at the first row that fails its predicate** - [@norberttech](https://github.com/norberttech)
- [#2620](https://github.com/flow-php/flow/pull/2620) - **flow-php/etl - A read with no rows keeps the source schema instead of re-running the pipeline** - [@norberttech](https://github.com/norberttech)
- [#2620](https://github.com/flow-php/flow/pull/2620) - **flow-php/etl - A plan that reads its own output throws instead of segfaulting** - [@norberttech](https://github.com/norberttech)
- [#2620](https://github.com/flow-php/flow/pull/2620) - **flow-php/etl - A Hive null partition reads back as null, not ''** - [@norberttech](https://github.com/norberttech)
- [#2620](https://github.com/flow-php/flow/pull/2620) - **flow-php/etl - extract() closes every reader it opens** - [@norberttech](https://github.com/norberttech)
- [#2620](https://github.com/flow-php/flow/pull/2620) - **flow-php/etl - sortBy() accepts a bare column name** - [@norberttech](https://github.com/norberttech)
- [#2620](https://github.com/flow-php/flow/pull/2620) - **flow-php/etl - isIn() compares numbers the same way equals() does** - [@norberttech](https://github.com/norberttech)
- [#2620](https://github.com/flow-php/flow/pull/2620) - **flow-php/etl - Partition, pivot and Excel header errors name the right value, file and fix** - [@norberttech](https://github.com/norberttech)
- [#2620](https://github.com/flow-php/flow/pull/2620) - **flow-php/types - coalesce(), greatest() and least() treat a bare null type as nullable** - [@norberttech](https://github.com/norberttech)
- [#2620](https://github.com/flow-php/flow/pull/2620) - **flow-php/parquet - FLOAT32 values no longer lose precision on decode** - [@norberttech](https://github.com/norberttech)
- [#2620](https://github.com/flow-php/flow/pull/2620) - **flow-php/parquet - Nested decimals can be written and are sized by the Parquet spec** - [@norberttech](https://github.com/norberttech)
- [#2620](https://github.com/flow-php/flow/pull/2620) - **flow-php/filesystem - Path::addPartitions() keeps the partitions already attached** - [@norberttech](https://github.com/norberttech)
- [#2620](https://github.com/flow-php/flow/pull/2620) - **flow-php/filesystem - readLines() follows one contract on every stream** - [@norberttech](https://github.com/norberttech)
- [#2620](https://github.com/flow-php/flow/pull/2620) - **flow-php/filesystem-async-aws-bridge - S3 streams follow the shared readLines() contract** - [@norberttech](https://github.com/norberttech)
- [#2620](https://github.com/flow-php/flow/pull/2620) - **flow-php/filesystem-azure-bridge - Azure streams follow the shared readLines() contract** - [@norberttech](https://github.com/norberttech)
- [#2620](https://github.com/flow-php/flow/pull/2620) - **flow-php/etl-adapter-csv - Streams close on STOP, on a limit and when the hydrator throws** - [@norberttech](https://github.com/norberttech)
- [#2620](https://github.com/flow-php/flow/pull/2620) - **flow-php/etl-adapter-json - Blank lines, empty files and 0-byte documents no longer break reads** - [@norberttech](https://github.com/norberttech)
- [#2620](https://github.com/flow-php/flow/pull/2620) - **flow-php/etl-adapter-doctrine - Reads no longer add LIMIT/OFFSET to the caller's query builder** - [@norberttech](https://github.com/norberttech)
- [#2620](https://github.com/flow-php/flow/pull/2620) - **flow-php/etl-adapter-doctrine - A null DBAL platform option no longer breaks schema inference** - [@norberttech](https://github.com/norberttech)
- [#2620](https://github.com/flow-php/flow/pull/2620) - **flow-php/etl-adapter-postgresql - pgsql_table_to_flow_schema() maps array columns to lists** - [@norberttech](https://github.com/norberttech)
- [#2620](https://github.com/flow-php/flow/pull/2620) - **flow-php/postgresql - Arrays keep their SQL NULL values** - [@norberttech](https://github.com/norberttech)
...
- [#2620](https://github.com/flow-php/flow/pull/2620) - **flow-php/etl - DataFrame::partitionBy(), PartitioningProcessor and DropPartitionsTransformer** - [@norberttech](https://github.com/norberttech)
- [#2620](https://github.com/flow-php/flow/pull/2620) - **flow-php/etl - ExecutionMode::LENIENT** - [@norberttech](https://github.com/norberttech)
- [#2620](https://github.com/flow-php/flow/pull/2620) - **flow-php/etl - PipelineExtractor, from_pipeline(), GeneratorExtractor and Schema::fromPipeline()** - [@norberttech](https://github.com/norberttech)
- [#2620](https://github.com/flow-php/flow/pull/2620) - **flow-php/etl - BatchSizeOptimization and extractorBatchSize()** - [@norberttech](https://github.com/norberttech)
- [#2620](https://github.com/flow-php/flow/pull/2620) - **flow-php/etl - FilesystemStreams and Config::putInputIntoRows()** - [@norberttech](https://github.com/norberttech)
- [#2620](https://github.com/flow-php/flow/pull/2620) - **flow-php/etl - RowPadding, reorderEntries() and FieldOrderConformer** - [@norberttech](https://github.com/norberttech)
- [#2620](https://github.com/flow-php/flow/pull/2620) - **flow-php/etl - Floe DynamicEncoder and support for v1 files** - [@norberttech](https://github.com/norberttech)
- [#2620](https://github.com/flow-php/flow/pull/2620) - **flow-php/etl - json_pretty** - [@norberttech](https://github.com/norberttech)
- [#2620](https://github.com/flow-php/flow/pull/2620) - **flow-php/types - AutoCaster** - [@norberttech](https://github.com/norberttech)
