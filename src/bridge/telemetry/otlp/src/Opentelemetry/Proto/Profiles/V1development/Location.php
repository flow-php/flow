...
class Location extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .opentelemetry.proto.profiles.v1development.Line lines = 3;</code>
     */
    private $lines;
    /**
    ...
    public function setLines(array|RepeatedField $var)
    {
        $arr = GPBUtil::checkRepeatedField(
            ...
            \Opentelemetry\Proto\Profiles\V1development\Line::class,
        );
        $this->lines = $arr;
