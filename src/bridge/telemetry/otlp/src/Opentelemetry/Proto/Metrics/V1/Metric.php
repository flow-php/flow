...
class Metric extends \Google\Protobuf\Internal\Message
{
     ...
     * @return $this
     */
    public function setGauge(?\Opentelemetry\Proto\Metrics\V1\Gauge $var)
    {
     ...
     * @return $this
     */
    public function setSum(?\Opentelemetry\Proto\Metrics\V1\Sum $var)
    {
     ...
     * @return $this
     */
    public function setHistogram(?\Opentelemetry\Proto\Metrics\V1\Histogram $var)
    {
     ...
     * @return $this
     */
    public function setExponentialHistogram(?\Opentelemetry\Proto\Metrics\V1\ExponentialHistogram $var)
    {
     ...
     * @return $this
     */
    public function setSummary(?\Opentelemetry\Proto\Metrics\V1\Summary $var)
    {
