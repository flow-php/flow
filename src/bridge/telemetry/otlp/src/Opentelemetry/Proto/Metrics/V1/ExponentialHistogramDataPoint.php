...
class ExponentialHistogramDataPoint extends \Google\Protobuf\Internal\Message
{
     ...
     * @return $this
     */
    public function setPositive(?\Opentelemetry\Proto\Metrics\V1\ExponentialHistogramDataPoint\Buckets $var)
    {
        $this->positive = $var;
     ...
     * @return $this
     */
    public function setNegative(?\Opentelemetry\Proto\Metrics\V1\ExponentialHistogramDataPoint\Buckets $var)
    {
        $this->negative = $var;
