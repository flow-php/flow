...
class Span extends \Google\Protobuf\Internal\Message
{
    ...
    public function setEvents(array|RepeatedField $var)
    {
        $arr = GPBUtil::checkRepeatedField(
            $var,
            \Google\Protobuf\Internal\GPBType::MESSAGE,
            \Opentelemetry\Proto\Trace\V1\Span\Event::class,
        );
        $this->events = $arr;
    ...
    public function setLinks(array|RepeatedField $var)
    {
        $arr = GPBUtil::checkRepeatedField(
            $var,
            \Google\Protobuf\Internal\GPBType::MESSAGE,
            \Opentelemetry\Proto\Trace\V1\Span\Link::class,
        );
        $this->links = $arr;
     ...
     * @return $this
     */
    public function setStatus(?\Opentelemetry\Proto\Trace\V1\Status $var)
    {
        $this->status = $var;
