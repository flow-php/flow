...
class AnyValue extends \Google\Protobuf\Internal\Message
{
     ...
     * @return $this
     */
    public function setArrayValue(?\Opentelemetry\Proto\Common\V1\ArrayValue $var)
    {
     ...
     * @return $this
     */
    public function setKvlistValue(?\Opentelemetry\Proto\Common\V1\KeyValueList $var)
    {
     ...
     * Status: [Development]
     *
     * Generated from protobuf field <code>int32 string_value_strindex = 8;</code>
     * @return int
     */
