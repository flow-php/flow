...
final class GrpcTransportTest extends TestCase
{
    ...
    public function test_creates_transport_with_custom_headers(): void
    {
        ...
        $transport = new GrpcTransport(endpoint: 'localhost:4317', headers: ['Authorization' => 'Bearer token']);
    ...
    public function test_creates_transport_with_secure_mode(): void
    {
        ...
        $transport = new GrpcTransport(endpoint: 'localhost:4317', insecure: false);
    ...
    public function test_failover_receives_prior_batch_on_subsequent_send_and_throws_composite(): void
    {
        ...
        try {
            ...
            static::fail('Expected FailoverTransportException for batch A');
        ...
        try {
            $transport->shutdown();
            static::fail('Expected FailoverTransportException for batch B');
        } catch (FailoverTransportException $e) {
            static::assertCount(1, $e->failures);
            static::assertNull($e->failures[0]['failover']);
        }
    ...
    public function test_shutdown_with_zero_timeout_cancels_pending_calls_legacy_mode(): void
    {
        ...
        $transport = new GrpcTransport(endpoint: '127.0.0.1:1', timeoutMs: 60_000, shutdownTimeoutMs: 0);
