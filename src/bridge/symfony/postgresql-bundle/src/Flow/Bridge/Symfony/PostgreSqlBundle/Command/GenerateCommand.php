...
final class GenerateCommand extends Command
{
    ...
    protected function configure(): void
    {
        $this->addOption('connection', 'c', InputOption::VALUE_OPTIONAL, 'The connection to use', null)->addArgument(
            ...
            'The name of the migration (e.g. \'add_email_index\')',
        );
    }
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $generator = type_instance_of(MigrationGenerator::class)->assert($this->container->get(
            "flow.postgresql.{$connection}.migrations.generator",
        ));
