...
use function Flow\PostgreSql\DSL\{agg_count, col, create, eq, param, select};
...
final class CreateDatabaseCommand extends Command
{
    ...
    protected function configure() : void
    {
        $this
            ...
            ->addOption('if-not-exists', null, InputOption::VALUE_NONE, 'Don\'t error if database already exists');
    }
