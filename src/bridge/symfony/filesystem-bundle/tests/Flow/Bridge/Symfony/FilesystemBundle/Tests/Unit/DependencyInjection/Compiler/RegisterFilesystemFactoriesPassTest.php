...
final class RegisterFilesystemFactoriesPassTest extends TestCase
{
    public function test_does_nothing_when_registry_definition_absent() : void
    {
        ...
        self::assertFalse($container->hasDefinition('.flow_filesystem.factory_registry'));
    }
    ...
    public function test_injects_tagged_factories_as_references() : void
    {
        ...
        $argument = $container->getDefinition('.flow_filesystem.factory_registry')->getArgument(0);
        ...
        \sort($ids);
        self::assertSame(['.flow_filesystem.factory.file', '.flow_filesystem.factory.memory'], $ids);
    }
    ...
    public function test_throws_on_tag_without_type_attribute() : void
    {
        ...
        $memory = new Definition(MemoryFilesystemFactory::class);
        $memory->addTag('flow_filesystem.factory');
        $container->setDefinition('.flow_filesystem.factory.memory', $memory);
