...
final class SessionCatalogProviderTest extends TestCase
{
    ...
    public function test_get_returns_catalog_with_custom_schema(): void
    {
        ...
        static::assertSame(['session'], $catalog->names());
    }
    ...
    public function test_id_column_is_primary_key_and_varchar_128(): void
    {
        ...
        static::assertSame(['sess_id'], $table->primaryKey?->columns);
        static::assertTrue($table->column('sess_id')->type->isEqual(ColumnType::varchar(128)));
        static::assertFalse($table->column('sess_id')->nullable);
    }
    ...
    public function test_index_on_lifetime_uses_table_prefix(): void
    {
        ...
        static::assertSame('idx_app_sessions_lifetime', $indexes[0]->name);
        static::assertSame(['sess_lifetime'], $indexes[0]->columns);
    }
    ...
    public function test_table_has_custom_columns(): void
    {
        ...
        static::assertSame(['sid', 'sdata', 'sttl', 'sts'], $table->columnNames());
        static::assertSame(['sid'], $table->primaryKey?->columns);
    }
    ...
    public function test_table_has_custom_name_and_schema(): void
    {
        ...
        static::assertSame('app_sessions', $table->name);
    ...
    public function test_table_has_default_name(): void
    {
        ...
        static::assertSame('sessions', $table->name);
    }
