...
use Flow\Bridge\Symfony\TelemetryBundle\Instrumentation\Messenger\TelemetryStampCarrier;
...
final class TelemetryStampCarrierTest extends TestCase
{
    ...
    public function test_constructs_with_provided_stamp(): void
    {
        ...
        static::assertSame('value', $carrier->unwrap()->get('traceparent'));
    }
    ...
    public function test_get_delegates_to_underlying_stamp(): void
    {
        ...
        static::assertSame('value', $carrier->get('traceparent'));
        static::assertSame('vendor=data', $carrier->get('tracestate'));
    }
    ...
    public function test_set_can_be_chained_multiple_times(): void
    {
        ...
        $carrier->set('traceparent', 'trace-value')->set('tracestate', 'state-value')->set('baggage', 'baggage-value');

        static::assertSame('trace-value', $carrier->get('traceparent'));
        static::assertSame('state-value', $carrier->get('tracestate'));
        static::assertSame('baggage-value', $carrier->get('baggage'));
    }
    ...
    public function test_unwrap_returns_current_stamp(): void
    {
        ...
        static::assertSame('original', $stamp->get('key'));
    }
    ...
    public function test_unwrap_returns_stamp_with_all_set_values(): void
    {
        ...
        static::assertSame('trace', $stamp->get('traceparent'));
        static::assertSame('state', $stamp->get('tracestate'));
        static::assertCount(2, $stamp->all());
    }
}
