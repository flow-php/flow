...
final class CacheCatalogProviderTest extends TestCase
{
    public function test_data_column_is_bytea_not_null(): void
    {
        ...
        static::assertFalse($col->nullable);
        static::assertTrue($col->type->isEqual(ColumnType::bytea()));
    }
    ...
    public function test_get_returns_catalog_with_custom_schema(): void
    {
        ...
        static::assertSame(['cache'], $catalog->names());
    }
    ...
    public function test_id_column_is_primary_key_and_varchar_255(): void
    {
        ...
        static::assertSame(['item_id'], $table->primaryKey?->columns);
        static::assertTrue($table->column('item_id')->type->isEqual(ColumnType::varchar(255)));
        static::assertFalse($table->column('item_id')->nullable);
    }
    ...
    public function test_index_on_lifetime_time_uses_table_prefix(): void
    {
        ...
        static::assertSame('idx_my_cache_lifetime_time', $indexes[0]->name);
        static::assertSame(['item_lifetime', 'item_time'], $indexes[0]->columns);
    }
    ...
    public function test_lifetime_column_is_integer_nullable(): void
    {
        ...
        static::assertTrue($col->type->isEqual(ColumnType::integer()));
    }
    ...
    public function test_table_has_custom_columns(): void
    {
        ...
        static::assertSame(['cid', 'cdata', 'cttl', 'cts'], $table->columnNames());
        static::assertSame(['cid'], $table->primaryKey?->columns);
    }
    ...
    public function test_table_has_custom_name_and_schema(): void
    {
        ...
        static::assertSame('app_cache', $table->name);
    ...
    public function test_table_has_default_name(): void
    {
        ...
        static::assertSame('cache_items', $table->name);
    }
