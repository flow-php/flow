...
final class FlowPostgreSqlCacheAdapterTest extends TestCase
{
    ...
    public function test_clear_with_empty_prefix_truncates_table() : void
    {
        ...
        self::assertSame('TRUNCATE public.cache_items', $this->context->client->executedQueries[0]['sql']);
        self::assertSame([], $this->context->client->executedQueries[0]['parameters']);
    }
    ...
    public function test_clear_with_prefix_uses_like_pattern() : void
    {
        ...
        self::assertTrue($adapter->clear('user_'));
        self::assertSame('DELETE FROM public.cache_items WHERE item_id LIKE $1', $this->context->client->executedQueries[0]['sql']);
        self::assertSame(['user_%'], $this->context->client->executedQueries[0]['parameters']);
    }
    ...
    public function test_delete_items_uses_in_clause() : void
    {
        ...
        self::assertTrue($adapter->deleteItems(['a', 'b', 'c']));
        self::assertSame('DELETE FROM public.cache_items WHERE item_id IN ($1, $2, $3)', $this->context->client->executedQueries[0]['sql']);
        self::assertSame(['a', 'b', 'c'], $this->context->client->executedQueries[0]['parameters']);
    }
    ...
    public function test_delete_items_with_empty_list_is_a_noop() : void
    {
        ...
        self::assertTrue($adapter->deleteItems([]));
    ...
    public function test_get_items_deletes_expired_rows_after_iteration() : void
    {
        ...
        self::assertCount(2, $this->context->client->executedQueries);
        self::assertStringStartsWith('DELETE FROM public.cache_items WHERE item_id IN', $this->context->client->executedQueries[1]['sql']);
        self::assertSame(['stale'], $this->context->client->executedQueries[1]['parameters']);
    }
    ...
    public function test_get_items_emits_id_to_value_pairs_for_non_expired_rows() : void
    {
        ...
        self::assertSame('hello', $items['a']->get());
        self::assertSame(42, $items['b']->get());
    ...
    public function test_get_items_with_empty_keys_is_a_noop() : void
    {
        ...
        self::assertSame([], \iterator_to_array($adapter->getItems([])));
        self::assertSame([], $this->context->client->executedQueries);
    }
    ...
    public function test_has_item_returns_false_when_row_missing() : void
    {
        ...
        self::assertFalse($adapter->hasItem('missing'));
    }
    ...
    public function test_has_item_returns_true_when_row_present_and_not_expired() : void
    {
        ...
        self::assertTrue($adapter->hasItem('present'));
        ...
        self::assertSame('present', $this->context->client->executedQueries[0]['parameters'][0]);
    }
    ...
    public function test_save_deferred_returns_failed_keys_for_marshaller_failures() : void
    {
        ...
        self::assertSame('good', $insertQueries[0]['parameters'][0]);
    }
    ...
    public function test_save_uses_insert_on_conflict_update_via_dsl() : void
    {
        ...
        self::assertSame(1, $this->context->client->transactionCallCount);
        self::assertCount(1, $insertQueries);
        ...
        self::assertSame('key1', $insertQueries[0]['parameters'][0]);
        self::assertSame(600, $insertQueries[0]['parameters'][2]);
    }
    ...
    public function test_save_with_zero_lifetime_uses_null_for_lifetime_column() : void
    {
        ...
        self::assertCount(1, $insertQueries);
        self::assertNull($insertQueries[0]['parameters'][2]);
    }
}
