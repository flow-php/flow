...
use function Flow\Telemetry\DSL\{logger_provider, memory_context_storage, memory_log_processor, memory_metric_processor, memory_span_processor, meter_provider, tracer_provider, void_log_exporter, void_metric_exporter, void_span_exporter};
...
final class TelemetryMother
{
    public static function create(?MemorySpanProcessor $spanProcessor = null) : Telemetry
    {
        ...
        return new Telemetry(
            ...
            meter_provider(
                memory_metric_processor(void_metric_exporter()),
                $clock,
            ),
            logger_provider(
                memory_log_processor(void_log_exporter()),
                $clock,
                $contextStorage,
            ),
        );
