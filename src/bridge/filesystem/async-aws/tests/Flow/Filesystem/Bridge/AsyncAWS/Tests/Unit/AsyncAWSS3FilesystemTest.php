...
final class AsyncAWSS3FilesystemTest extends TestCase
{
    public function test_append_to_rejects_mismatched_scheme() : void
    {
        ...
        $this->expectExceptionMessage('Scheme "file://" is not supported by this protocol. Expected scheme is "aws-s3://"');

        aws_s3_filesystem('bucket', $this->createMock(S3Client::class))
    ...
    public function test_mv_rejects_mismatched_destination_scheme() : void
    {
        ...
        aws_s3_filesystem('bucket', $this->createMock(S3Client::class))
            ->mv(path('aws-s3://var/a.txt'), path('file:///var/b.txt'));
    }
    ...
    public function test_mv_rejects_mismatched_source_scheme() : void
    {
        ...
        aws_s3_filesystem('bucket', $this->createMock(S3Client::class))
            ->mv(path('file:///var/a.txt'), path('aws-s3://var/b.txt'));
    }
