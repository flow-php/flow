...
final class AzureBlobFilesystemTest extends TestCase
{
    public function test_append_to_rejects_mismatched_scheme() : void
    {
        ...
        $this->expectExceptionMessage('Scheme "file://" is not supported by this protocol. Expected scheme is "azure-blob://"');

        azure_filesystem($this->createMock(BlobServiceInterface::class))
            ->appendTo(path('file:///var/foo.txt'));
    }
    ...
    public function test_mv_rejects_mismatched_destination_scheme() : void
    {
        ...
        azure_filesystem($this->createMock(BlobServiceInterface::class))
            ->mv(path('azure-blob://var/a.txt'), path('file:///var/b.txt'));
    }
    ...
    public function test_mv_rejects_mismatched_source_scheme() : void
    {
        ...
        azure_filesystem($this->createMock(BlobServiceInterface::class))
            ->mv(path('file:///var/a.txt'), path('azure-blob://var/b.txt'));
    }
    ...
    public function test_read_from_rejects_mismatched_scheme() : void
    {
        ...
        azure_filesystem($this->createMock(BlobServiceInterface::class))
            ->readFrom(path('file:///var/foo.txt'));
    }
