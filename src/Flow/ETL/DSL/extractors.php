 ...
 * @param callable(RequestInterface) : void $pre_request
 * @param callable(RequestInterface, ResponseInterface) : void $post_request
 */
...
/**
 * @param ClientInterface $client
 * @param NextRequestFactory $request_factory
 * @param callable(RequestInterface) : void $pre_request
 * @param callable(RequestInterface, ResponseInterface) : void $post_request
 */
 ...
 * @param string $query
 * @param ?ParametersSet $parameters_set
