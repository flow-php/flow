...
final class LogEntryMother
{
     ...
     */
    public static function create(string $body, Severity $severity, array $attributes = [], ?SpanContext $spanContext = null) : LogEntry
    {
        return new LogEntry(
     ...
     * @param array<string, array<bool|\DateTimeImmutable|float|int|string>|bool|\DateTimeImmutable|float|int|string> $attributes
     */
    public static function deterministic(string $body, Severity $severity, array $attributes = [], ?SpanContext $spanContext = null) : LogEntry
    {
        return new LogEntry(
            (new LogRecord())->setSeverity($severity)->setBody($body)->setAttributes($attributes),
            ResourceMother::full(),
