...
final class ConsoleOutputTest extends TestCase
{
    ...
    public function test_color_disabled_returns_plain_text() : void
    {
        ...
        self::assertSame('test', $output->red('test'));
        self::assertSame('test', $output->green('test'));
        self::assertSame('test', $output->blue('test'));
    }
    ...
    public function test_color_enabled_wraps_text_with_ansi() : void
    {
        ...
        self::assertStringContainsString("\033[", $output->red('test'));
        self::assertStringContainsString('test', $output->red('test'));
    }
    ...
    public function test_format_duration_microseconds() : void
    {
        ...
        self::assertStringContainsString('us', $output->formatDuration(0.5));
    }
    ...
    public function test_format_duration_milliseconds() : void
    {
        ...
        self::assertStringContainsString('ms', $output->formatDuration(50.5));
    }
    ...
    public function test_format_duration_null_returns_dash() : void
    {
        ...
        self::assertSame('-', $output->formatDuration(null));
    }
    ...
    public function test_format_duration_seconds() : void
    {
        ...
        self::assertStringContainsString('s', $output->formatDuration(5000.0));
    }
    ...
    public function test_format_timestamp() : void
    {
        ...
        self::assertSame('2024-01-15 10:30:45.123456', $result);
    }
    ...
    public function test_format_value_array() : void
    {
        ...
        self::assertSame('["a","b"]', $output->formatValue(['a', 'b']));
    }
    ...
    public function test_format_value_bool() : void
    {
        ...
        self::assertSame('true', $output->formatValue(true));
        self::assertSame('false', $output->formatValue(false));
    }
    ...
    public function test_format_value_null() : void
    {
        ...
        self::assertSame('null', $output->formatValue(null));
    }
    ...
    public function test_format_value_number() : void
    {
        ...
        self::assertSame('42', $output->formatValue(42));
        self::assertSame('3.14', $output->formatValue(3.14));
    }
    ...
    public function test_format_value_string() : void
    {
        ...
        self::assertSame('hello', $output->formatValue('hello'));
    }
    ...
    public function test_pad_left() : void
    {
        ...
        self::assertSame('   abc', $output->pad('abc', 6, ' ', STR_PAD_LEFT));
    }
    ...
    public function test_pad_right() : void
    {
        ...
        self::assertSame('abc   ', $output->pad('abc', 6, ' ', STR_PAD_RIGHT));
    }
    ...
    public function test_strip_colors_removes_ansi() : void
    {
        ...
        self::assertSame('test', $output->stripColors($colored));
    }
    ...
    public function test_truncate_long_text() : void
    {
        ...
        self::assertSame('hello...', $output->truncate('hello world this is a long text', 8));
    }
    ...
    public function test_truncate_short_text_unchanged() : void
    {
        ...
        self::assertSame('hello', $output->truncate('hello', 10));
    }
