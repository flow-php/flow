...
final class AttributeLimitsEnforcerTest extends TestCase
{
    public function test_applies_both_count_and_length_limits(): void
    {
        ...
        static::assertSame(3, $result->attributes->count());
        static::assertSame(1, $result->droppedAttributeCount);
        static::assertSame('short', $result->attributes->get('key1'));
        static::assertSame('this-is-a-', $result->attributes->get('key2'));
        static::assertSame('another-lo', $result->attributes->get('key3'));
    }
    ...
    public function test_does_not_drop_attributes_when_exactly_at_limit(): void
    {
        ...
        static::assertSame(3, $result->attributes->count());
        static::assertSame(0, $result->droppedAttributeCount);
    }
    ...
    public function test_does_not_drop_attributes_when_under_limit(): void
    {
        ...
        static::assertSame(3, $result->attributes->count());
        static::assertSame(0, $result->droppedAttributeCount);
        static::assertSame('value1', $result->attributes->get('key1'));
        static::assertSame('value2', $result->attributes->get('key2'));
        static::assertSame('value3', $result->attributes->get('key3'));
    }
    ...
    public function test_does_not_modify_non_string_values(): void
    {
        ...
        static::assertSame(123456789012345, $result->attributes->get('int'));
        static::assertSame(123456.789012345, $result->attributes->get('float'));
        static::assertTrue($result->attributes->get('bool'));
    }
    ...
    public function test_drops_attributes_exceeding_count_limit(): void
    {
        ...
        static::assertSame(3, $result->attributes->count());
        static::assertSame(2, $result->droppedAttributeCount);
        static::assertSame('value1', $result->attributes->get('key1'));
        static::assertSame('value2', $result->attributes->get('key2'));
        static::assertSame('value3', $result->attributes->get('key3'));
        static::assertNull($result->attributes->get('key4'));
        static::assertNull($result->attributes->get('key5'));
    }
    ...
    public function test_handles_empty_attributes(): void
    {
        ...
        static::assertSame(0, $result->attributes->count());
        static::assertSame(0, $result->droppedAttributeCount);
    }
    ...
    public function test_preserves_array_with_non_string_values(): void
    {
        ...
        static::assertSame([1, 2.5, true, 'truncate-t'], $result->attributes->get('mixed'));
    }
    ...
    public function test_truncates_array_string_values(): void
    {
        ...
        static::assertSame(['short', 'this-is-a-'], $result->attributes->get('tags'));
    }
    ...
    public function test_truncates_string_values_exceeding_length_limit(): void
    {
        ...
        static::assertSame('abc', $result->attributes->get('short'));
        static::assertSame('abcdefghij', $result->attributes->get('long'));
        static::assertSame(0, $result->droppedAttributeCount);
    }
    ...
    public function test_truncates_string_values_using_utf8_safe_substring(): void
    {
        ...
        static::assertSame('Zażółć gęś', $result->attributes->get('unicode'));
    }
}
