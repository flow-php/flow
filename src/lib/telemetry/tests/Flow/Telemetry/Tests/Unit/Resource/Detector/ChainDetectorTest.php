...
final class ChainDetectorTest extends TestCase
{
    public function test_chain_with_three_detectors_merges_all(): void
    {
        ...
        static::assertSame('1', $resource->get('a'));
        static::assertSame('2', $resource->get('b'));
        static::assertSame('3', $resource->get('c'));
        static::assertSame('third', $resource->get('common'));
    }
    ...
    public function test_detect_executes_detectors_in_order(): void
    {
        ...
        static::assertSame([1, 2], $executionOrder);
        static::assertSame('2', $resource->get('order'));
    }
    ...
    public function test_detect_merges_multiple_detectors(): void
    {
        ...
        static::assertSame('value1', $resource->get('key1'));
        static::assertSame('value2', $resource->get('key2'));
    }
    ...
    public function test_later_detectors_override_earlier_ones(): void
    {
        ...
        static::assertSame('override', $resource->get('key'));
        static::assertSame('first', $resource->get('only1'));
        static::assertSame('second', $resource->get('only2'));
    }
