...
final class LoggingIntegrationTest extends TestCase
{
    ...
    public function test_complete_logging_workflow(): void
    {
        ...
        static::assertCount(5, $processor->entries());
        static::assertCount(2, $processor->entriesWithSeverity(Severity::INFO));
        static::assertCount(1, $processor->entriesWithSeverity(Severity::ERROR));
    ...
    public function test_filtering_logs_by_severity_and_content(): void
    {
        ...
        static::assertCount(7, $processor->entries());
        static::assertCount(2, $processor->entriesWithSeverity(Severity::INFO));
        static::assertCount(2, $processor->entriesContaining('logged'));
    }
    ...
    public function test_multiple_services_logging(): void
    {
        ...
        static::assertCount(5, $processor->entries());
        static::assertCount(4, $processor->entriesWithSeverity(Severity::INFO));
        static::assertCount(1, $processor->entriesWithSeverity(Severity::DEBUG));
    }
    ...
    public function test_processor_reset_clears_logs(): void
    {
        ...
        static::assertCount(0, $processor->entries());
    ...
    public function test_span_context_correlation(): void
    {
        ...
        static::assertNotNull($entry->spanContext);
        static::assertSame($traceId->toHex(), $entry->spanContext->traceId->toHex());
        static::assertSame($spanId->toHex(), $entry->spanContext->spanId->toHex());
    }
