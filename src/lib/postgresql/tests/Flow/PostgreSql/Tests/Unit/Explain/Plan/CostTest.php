...
final class CostTest extends TestCase
{
    ...
    {
        $original = new Cost(startupCost: 10.5, totalCost: 150.75);
    ...
    public function test_from_array_creates_instance(): void
    {
        ...
        static::assertSame(10.5, $cost->startupCost());
        static::assertSame(150.75, $cost->totalCost());
    }

    public function test_normalize_returns_all_fields(): void
    {
        $cost = new Cost(startupCost: 10.5, totalCost: 150.75);

        $normalized = $cost->normalize();

        static::assertSame(10.5, $normalized['startup_cost']);
        static::assertSame(150.75, $normalized['total_cost']);
    }

    public function test_normalize_returns_expected_keys(): void
    {
        $cost = new Cost(startupCost: 0.0, totalCost: 100.0);
