...
final class LongestCommonSubstringStrategyTest extends TestCase
{
    ...
    {
        self::assertSame(100.0, (new LongestCommonSubstringStrategy())->similarity('', ''));
    }
    ...
    public function test_common_prefix_with_different_suffix() : void
    {
        ...
        self::assertGreaterThan($noOverlap, $withSuffix);
    }

    public function test_custom_threshold() : void
    {
        self::assertSame(75.0, (new LongestCommonSubstringStrategy(75.0))->threshold());
    }

    public function test_default_threshold_is_50() : void
    {
        self::assertSame(50.0, (new LongestCommonSubstringStrategy())->threshold());
    }

    public function test_identical_names_score_100() : void
    {
        self::assertSame(100.0, (new LongestCommonSubstringStrategy())->similarity('column_name', 'column_name'));
    }

    public function test_no_common_characters_scores_0() : void
    {
        self::assertSame(0.0, (new LongestCommonSubstringStrategy())->similarity('abc', 'xyz'));
    }

    public function test_one_empty_string_scores_0() : void
    {
        self::assertSame(0.0, (new LongestCommonSubstringStrategy())->similarity('', 'something'));
    }

    public function test_realistic_column_rename_suffix_removed() : void
    {
        self::assertEqualsWithDelta(70.0, (new LongestCommonSubstringStrategy())->similarity('net_commission_cents', 'net_commission'), 0.01);
    }

    public function test_reversed_single_chars_share_one_character_substring() : void
    {
        self::assertSame(50.0, (new LongestCommonSubstringStrategy())->similarity('ax', 'xa'));
    }
}
