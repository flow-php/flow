...
use function Flow\PostgreSql\DSL\{sql_explain_config, sql_to_explain};
...
final class ExplainModifierTest extends TestCase
{
    ...
    public function test_analyze_config_includes_all_options() : void
    {
        ...
        self::assertSame(ExplainFormat::JSON, $config->format);
    }
    ...
    public function test_estimate_config_generates_explain_without_analyze() : void
    {
        ...
        self::assertSame('EXPLAIN (COSTS 1, FORMAT "json") SELECT id FROM orders', $result);
    }
...
SQL;
    ...
    public function test_wraps_select_with_explain_estimate() : void
    {
        ...
        self::assertSame(
            'EXPLAIN (COSTS 1, FORMAT "json") SELECT * FROM users',
            $result
        );
    }
}
