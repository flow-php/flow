...
final class TableComparatorTest extends TestCase
{
    public function test_ambiguous_column_rename_resolved_by_similarity(): void
    {
        ...
        static::assertCount(0, $diff->addedColumns);
        static::assertCount(1, $diff->removedColumns);
        static::assertCount(1, $diff->modifiedColumns);
        static::assertTrue($diff->modifiedColumns[0]->hasNameChanged());
    }
    ...
    public function test_column_added(): void
    {
        ...
        static::assertCount(1, $diff->addedColumns);
        static::assertSame('email', $diff->addedColumns[0]->name);
    }
    ...
    public function test_column_default_changed(): void
    {
        ...
        static::assertCount(1, $diff->modifiedColumns);
        static::assertTrue($diff->modifiedColumns[0]->hasDefaultChanged());
    }
    ...
    public function test_column_generation_changed(): void
    {
        ...
        $target = schema_table('users', [schema_column(
            'full_name',
            ColumnType::text(),
            isGenerated: true,
        ...
        static::assertCount(1, $diff->modifiedColumns);
        static::assertTrue($diff->modifiedColumns[0]->hasGenerationChanged());
    }
    ...
    public function test_column_identity_changed(): void
    {
        ...
        $source = schema_table('users', [schema_column(
            'id',
            ColumnType::integer(),
            nullable: false,
            isIdentity: false,
        ...
        static::assertCount(1, $diff->modifiedColumns);
        static::assertTrue($diff->modifiedColumns[0]->hasIdentityChanged());
    }
    ...
    public function test_column_nullable_changed(): void
    {
        ...
        static::assertCount(1, $diff->modifiedColumns);
        static::assertTrue($diff->modifiedColumns[0]->hasNullableChanged());
    }
    ...
    public function test_column_removed(): void
    {
        ...
        static::assertCount(1, $diff->removedColumns);
        static::assertSame('email', $diff->removedColumns[0]->name);
    }
    ...
    public function test_column_rename_detected(): void
    {
        ...
        static::assertSame([], $diff->addedColumns);
        static::assertSame([], $diff->removedColumns);
        static::assertCount(1, $diff->modifiedColumns);
        static::assertTrue($diff->modifiedColumns[0]->hasNameChanged());
        static::assertSame('email', $diff->modifiedColumns[0]->source->name);
        static::assertSame('mail', $diff->modifiedColumns[0]->target->name);
    }
    ...
    public function test_column_type_changed(): void
    {
        ...
        static::assertCount(1, $diff->modifiedColumns);
        static::assertTrue($diff->modifiedColumns[0]->hasTypeChanged());
    }
    ...
    public function test_primary_key_added(): void
    {
        ...
        static::assertNotNull($diff->addedPrimaryKey);
        static::assertSame(['id'], $diff->addedPrimaryKey->columns);
        static::assertNull($diff->removedPrimaryKey);
    }
    ...
    public function test_primary_key_changed(): void
    {
        ...
        $target = schema_table(
            'users',
            [schema_column_integer('id', false), schema_column_text('email')],
            primaryKey: schema_primary_key(['id', 'email']),
        );

        $diff = $comparator->compare($source, $target);

        static::assertNotNull($diff->addedPrimaryKey);
        static::assertNotNull($diff->removedPrimaryKey);
    }
    ...
    public function test_primary_key_removed(): void
    {
        ...
        static::assertNull($diff->addedPrimaryKey);
        static::assertNotNull($diff->removedPrimaryKey);
        static::assertSame(['id'], $diff->removedPrimaryKey->columns);
    }
    ...
    public function test_trigger_added(): void
    {
        ...
        static::assertSame('trg_audit', $diff->addedTriggers[0]->name);
    }
    ...
    public function test_trigger_removed(): void
    {
        ...
        static::assertCount(1, $diff->removedTriggers);
        static::assertSame('trg_audit', $diff->removedTriggers[0]->name);
    }
}
