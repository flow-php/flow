...
final class TimingTest extends TestCase
{
    ...
    public function test_from_array_creates_instance() : void
    {
        ...
        self::assertSame(0.5, $timing->startupTime());
        self::assertSame(25.75, $timing->totalTime());
        self::assertSame(3, $timing->loops());
    }
    ...
    public function test_normalize_returns_all_fields() : void
    {
        ...
        self::assertSame(0.5, $normalized['startup_time']);
        self::assertSame(25.75, $normalized['total_time']);
        self::assertSame(3, $normalized['loops']);
    }
