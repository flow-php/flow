...
use Flow\PostgreSql\Schema\{View, ViewDependencyOrder};
...
final class ViewDependencyOrderTest extends TestCase
{
    ...
    {
        self::assertSame([], (new ViewDependencyOrder(new \Flow\PostgreSql\Parser()))->order([]));
    }
    ...
    public function test_linear_chain() : void
    {
        ...
        self::assertSame(['base_view', 'middle_view', 'top_view'], $names);
    }
    ...
    public function test_self_referencing_view() : void
    {
        ...
        self::assertSame(['recursive_view', 'other_view'], $names);
    }
    ...
    public function test_single_view() : void
    {
        ...
        self::assertSame('my_view', $result[0]->name);
    }
    ...
    public function test_view_referencing_external_table_is_not_affected() : void
    {
        ...
        self::assertSame('view_a', $result[0]->name);
        self::assertSame('view_b', $result[1]->name);
    }
