...
use Flow\PostgreSql\Schema\{MaterializedView, MaterializedViewDependencyOrder};
...
final class MaterializedViewDependencyOrderTest extends TestCase
{
    ...
    {
        self::assertSame([], (new MaterializedViewDependencyOrder(new Parser()))->order([]));
    }
    ...
    public function test_linear_chain() : void
    {
        ...
        self::assertSame(['base_mv', 'top_mv'], $names);
    }
    ...
    public function test_self_referencing_materialized_view() : void
    {
        ...
        self::assertSame(['recursive_mv', 'other_mv'], $names);
    }
    ...
    public function test_single_materialized_view() : void
    {
        ...
        self::assertSame('my_mv', $result[0]->name);
    }
