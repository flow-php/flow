...
final class DateConverterTest extends TestCase
{
    ...
    public static function provide_valid_values() : \Generator
    {
        ...
        yield 'with timezone' => [new \DateTimeImmutable('2024-01-15 00:00:00', new \DateTimeZone('America/New_York')), '2024-01-15'];
    ...
    {
        $converter = new DateConverter();
        self::assertContains(ValueType::DATE, $converter->supportedTypes());
    }
