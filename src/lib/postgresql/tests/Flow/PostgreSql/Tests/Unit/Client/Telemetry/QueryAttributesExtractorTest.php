...
final class QueryAttributesExtractorTest extends TestCase
{
    public function test_extract_both_operation_and_target() : void
    {
        ...
        self::assertSame('SELECT', $result->operation);
        self::assertSame('users', $result->target);
    }
    ...
    public function test_extract_insert_into_table() : void
    {
        ...
        self::assertSame('INSERT', $result->operation);
        self::assertSame('users', $result->target);
    }
    ...
    public function test_extract_operation_alter() : void
    {
        ...
        self::assertSame('ALTER', $extractor->extractOperation('ALTER TABLE users ADD COLUMN email VARCHAR(255)'));
    }
    ...
    public function test_extract_operation_begin() : void
    {
        ...
        self::assertSame('BEGIN', $extractor->extractOperation('BEGIN'));
    }
    ...
    public function test_extract_operation_commit() : void
    {
        ...
        self::assertSame('COMMIT', $extractor->extractOperation('COMMIT'));
    }
    ...
    public function test_extract_operation_copy() : void
    {
        ...
        self::assertSame('COPY', $extractor->extractOperation('COPY users TO stdout'));
    }
    ...
    public function test_extract_operation_create() : void
    {
        ...
        self::assertSame('CREATE', $extractor->extractOperation('CREATE TABLE users (id SERIAL PRIMARY KEY)'));
    }
    ...
    public function test_extract_operation_delete() : void
    {
        ...
        self::assertSame('DELETE', $extractor->extractOperation('DELETE FROM users WHERE id = 1'));
    }
    ...
    public function test_extract_operation_drop() : void
    {
        ...
        self::assertSame('DROP', $extractor->extractOperation('DROP TABLE users'));
    }
    ...
    public function test_extract_operation_explain() : void
    {
        ...
        self::assertSame('EXPLAIN', $extractor->extractOperation('EXPLAIN ANALYZE SELECT * FROM users'));
    }
    ...
    public function test_extract_operation_from_case_insensitive_query() : void
    {
        ...
        self::assertSame('SELECT', $extractor->extractOperation('select * FROM users'));
    }
    ...
    public function test_extract_operation_insert() : void
    {
        ...
        self::assertSame('INSERT', $extractor->extractOperation('INSERT INTO users (name) VALUES ($1)'));
    }
    ...
    public function test_extract_operation_merge() : void
    {
        ...
        self::assertSame('MERGE', $extractor->extractOperation('MERGE INTO users USING source ON users.id = source.id'));
    }
    ...
    public function test_extract_operation_returns_null_for_unknown_operation() : void
    {
        ...
        self::assertNull($extractor->extractOperation('VACUUM users'));
    }
    ...
    public function test_extract_operation_rollback() : void
    {
        ...
        self::assertSame('ROLLBACK', $extractor->extractOperation('ROLLBACK'));
    }
    ...
    public function test_extract_operation_truncate() : void
    {
        ...
        self::assertSame('TRUNCATE', $extractor->extractOperation('TRUNCATE TABLE users'));
    }
    ...
    public function test_extract_operation_update() : void
    {
        ...
        self::assertSame('UPDATE', $extractor->extractOperation('UPDATE users SET name = $1 WHERE id = $2'));
    }
    ...
    public function test_extract_operation_with() : void
    {
        ...
        self::assertSame('WITH', $extractor->extractOperation('WITH cte AS (SELECT * FROM users) SELECT * FROM cte'));
    }
    ...
    public function test_extract_schema_qualified_table() : void
    {
        ...
        self::assertSame('SELECT', $result->operation);
        self::assertSame('public.users', $result->target);
    }
    ...
    public function test_extract_target_finds_first_from_clause() : void
    {
        ...
        self::assertSame('orders', $extractor->extractTarget('SELECT * FROM orders o'));
    }
    ...
    public function test_extract_target_from_delete() : void
    {
        ...
        self::assertSame('users', $extractor->extractTarget('DELETE FROM users WHERE id = 1'));
    }
    ...
    public function test_extract_target_from_insert() : void
    {
        ...
        self::assertSame('users', $extractor->extractTarget('INSERT INTO users (name) VALUES ($1)'));
    }
    ...
    public function test_extract_target_from_quoted_table() : void
    {
        ...
        self::assertSame('Users', $extractor->extractTarget('SELECT * FROM "Users"'));
    }
    ...
    public function test_extract_target_from_schema_qualified_table() : void
    {
        ...
        self::assertSame('public.users', $extractor->extractTarget('SELECT * FROM public.users'));
    }
    ...
    public function test_extract_target_from_select() : void
    {
        ...
        self::assertSame('users', $extractor->extractTarget('SELECT * FROM users WHERE id = 1'));
    }
    ...
    public function test_extract_target_from_update() : void
    {
        ...
        self::assertSame('users', $extractor->extractTarget('UPDATE users SET name = $1 WHERE id = $2'));
    }
    ...
    public function test_extract_target_prefers_from_over_join() : void
    {
        ...
        self::assertSame('orders', $extractor->extractTarget('SELECT * FROM orders JOIN users ON orders.user_id = users.id'));
    }
    ...
    public function test_extract_target_returns_null_for_query_without_table() : void
    {
        ...
        self::assertNull($extractor->extractTarget('SELECT 1'));
    }
