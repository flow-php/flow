...
final class AnyTest extends TestCase
{
    ...
    public function test_converts_any_with_array_to_ast(): void
    {
        ...
        static::assertSame(A_Expr_Kind::AEXPR_OP_ANY, $aExpr->getKind());
    }
    ...
    public function test_converts_any_with_subquery_to_ast(): void
    {
        ...
        $condition = new Any(Column::name('id'), ComparisonOperator::GT, $subquery);
        ...
        static::assertSame(SubLinkType::ANY_SUBLINK, $subLink->getSubLinkType());
    }
    ...
    public function test_creates_any_condition_with_expression(): void
    {
        ...
        static::assertInstanceOf(Any::class, $condition);
    ...
    {
        $original = new Any(Column::name('id'), ComparisonOperator::LT, Literal::int(10));

        $node = $original->toAst();
        $reconstructed = Any::fromAst($node);

        static::assertInstanceOf(Any::class, $reconstructed);
    ...
    public function test_reconstructs_any_with_subquery_from_ast(): void
    {
        ...
        $original = new Any(Column::name('id'), ComparisonOperator::GT, $subquery);
