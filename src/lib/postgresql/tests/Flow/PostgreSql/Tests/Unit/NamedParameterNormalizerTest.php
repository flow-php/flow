...
final class NamedParameterNormalizerTest extends TestCase
{
    ...
    public function test_extract_parameters_single(): void
    {
        ...
        static::assertSame(['id' => 1], $normalizer->extractParameters('SELECT * FROM users WHERE id = :id'));
    }
    ...
    public function test_extract_parameters_without_parameters(): void
    {
        ...
        static::assertSame([], $normalizer->extractParameters('SELECT * FROM users'));
    }
    ...
    public function test_normalize_preserves_postgrecolumn_type_casts(): void
    {
        $normalizer = new NamedParameterNormalizer();
    ...
    public function test_normalize_without_parameters(): void
    {
        ...
        static::assertSame('SELECT * FROM users', $normalizer->normalize('SELECT * FROM users'));
    }
}
