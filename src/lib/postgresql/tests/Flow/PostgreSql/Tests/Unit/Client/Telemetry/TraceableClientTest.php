...
final class TraceableClientTest extends TestCase
{
    public function test_all_telemetry_disabled_does_not_wrap_cursor() : void
    {
        ...
        self::assertSame($mockCursor, $cursor);
    ...
    public function test_converters_delegates_to_underlying_client() : void
    {
        ...
        self::assertSame($converters, $client->converters());
    }
    ...
    public function test_cursor_returns_traceable_cursor_when_tracing_enabled() : void
    {
        ...
        self::assertInstanceOf(TraceableCursor::class, $cursor);
    }
    ...
    public function test_default_port_is_not_included_in_attributes() : void
    {
        ...
        self::assertArrayNotHasKey(PostgreSqlTelemetryAttributes::SERVER_PORT, $spans[0]->attributes());
    }
    ...
    public function test_execute_creates_span_with_correct_attributes() : void
    {
        ...
        self::assertSame('UPDATE', $span->attributes()[PostgreSqlTelemetryAttributes::DB_OPERATION_NAME]);
        self::assertSame('users', $span->attributes()[PostgreSqlTelemetryAttributes::DB_COLLECTION_NAME]);
        self::assertSame(5, $span->attributes()[PostgreSqlTelemetryAttributes::DB_RESPONSE_RETURNED_ROWS]);
    }
    ...
    public function test_fetch_null_result_records_zero_rows() : void
    {
        ...
        $spans = $spanProcessor->endedSpans();
        self::assertCount(1, $spans);
        self::assertSame(0, $spans[0]->attributes()[PostgreSqlTelemetryAttributes::DB_RESPONSE_RETURNED_ROWS]);
    }
    ...
    public function test_get_transaction_nesting_level_delegates() : void
    {
        ...
        self::assertSame(2, $client->getTransactionNestingLevel());
    }
    ...
    public function test_is_auto_commit_delegates() : void
    {
        ...
        self::assertTrue($client->isAutoCommit());
    }
    ...
    public function test_last_insert_id_delegates() : void
    {
        ...
        self::assertSame(42, $client->lastInsertId('users_id_seq'));
    }
    ...
    public function test_non_default_port_is_included_in_attributes() : void
    {
        ...
        $spans = $spanProcessor->endedSpans();
        self::assertCount(1, $spans);
        self::assertSame(5433, $spans[0]->attributes()[PostgreSqlTelemetryAttributes::SERVER_PORT]);
    }
    ...
    public function test_parameter_limits_ignored_when_include_parameters_false() : void
    {
        ...
        $spans = $spanProcessor->endedSpans();
        self::assertCount(1, $spans);
        self::assertArrayNotHasKey(PostgreSqlTelemetryAttributes::DB_QUERY_PARAMETER_PREFIX . '1', $spans[0]->attributes());
        self::assertArrayNotHasKey(PostgreSqlTelemetryAttributes::DB_QUERY_PARAMETER_PREFIX . '2', $spans[0]->attributes());
    }
    ...
    public function test_parameters_are_included_when_enabled() : void
    {
        ...
        $spans = $spanProcessor->endedSpans();
        self::assertCount(1, $spans);
        self::assertSame('John', $spans[0]->attributes()[PostgreSqlTelemetryAttributes::DB_QUERY_PARAMETER_PREFIX . '1']);
        self::assertSame('123', $spans[0]->attributes()[PostgreSqlTelemetryAttributes::DB_QUERY_PARAMETER_PREFIX . '2']);
    }
    ...
    public function test_query_text_is_not_truncated_when_max_length_null() : void
    {
        ...
        $spans = $spanProcessor->endedSpans();
        self::assertCount(1, $spans);
        self::assertSame($longQuery, $spans[0]->attributes()[PostgreSqlTelemetryAttributes::DB_QUERY_TEXT]);
    }
    ...
    public function test_query_text_is_truncated_when_max_length_set() : void
    {
        ...
        $spans = $spanProcessor->endedSpans();
        self::assertCount(1, $spans);
        self::assertSame('SELECT * FROM users ...', $spans[0]->attributes()[PostgreSqlTelemetryAttributes::DB_QUERY_TEXT]);
    }
    ...
    private function createMockClient(?ConnectionParameters $connectionParams = null) : Client
    {
        ...
        $mockClient->method('parameters')->willReturn(
            $connectionParams ?? pgsql_connection_params('testdb', 'localhost', 5432, 'user')
        );
