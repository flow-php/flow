...
final class CreateDatabaseBuilderTest extends TestCase
{
    ...
    {
        self::assertSame('CREATE DATABASE mydb', create()->database('mydb')->toSql());
    }

    public function test_create_database_ast_type() : void
    {
        self::assertInstanceOf(CreatedbStmt::class, CreateDatabaseBuilder::create('mydb')->toAst());
    }

    public function test_create_database_if_not_exists() : void
    {
        self::assertSame('CREATE DATABASE mydb IF_NOT_EXISTS 1', create()->database('mydb')->ifNotExists()->toSql());
    }
    ...
    public function test_create_database_immutability() : void
    {
        ...
        self::assertSame('CREATE DATABASE mydb', $original->toSql());
        self::assertSame('CREATE DATABASE mydb IF_NOT_EXISTS 1', $modified->toSql());
    }

    public function test_create_database_sets_name_in_ast() : void
    {
        self::assertSame('mydb', CreateDatabaseBuilder::create('mydb')->toAst()->getDbname());
    }
    ...
    {
        self::assertSame('CREATE DATABASE mydb ALLOW_CONNECTIONS 0', create()->database('mydb')->allowConnections(false)->toSql());
    }

    public function test_create_database_with_allow_connections_true() : void
    {
        self::assertSame('CREATE DATABASE mydb ALLOW_CONNECTIONS 1', create()->database('mydb')->allowConnections(true)->toSql());
    }

    public function test_create_database_with_builtin_locale() : void
    {
        self::assertSame('CREATE DATABASE mydb BUILTIN_LOCALE "C"', create()->database('mydb')->builtinLocale('C')->toSql());
    }

    public function test_create_database_with_collation_version() : void
    {
        self::assertSame('CREATE DATABASE mydb COLLATION_VERSION "1.0"', create()->database('mydb')->collationVersion('1.0')->toSql());
    }

    public function test_create_database_with_connection_limit() : void
    {
        self::assertSame('CREATE DATABASE mydb CONNECTION LIMIT 100', create()->database('mydb')->connectionLimit(100)->toSql());
    }

    public function test_create_database_with_encoding() : void
    {
        self::assertSame('CREATE DATABASE mydb ENCODING "UTF8"', create()->database('mydb')->encoding('UTF8')->toSql());
    }

    public function test_create_database_with_icu_locale() : void
    {
        self::assertSame('CREATE DATABASE mydb ICU_LOCALE "en-US"', create()->database('mydb')->icuLocale('en-US')->toSql());
    }

    public function test_create_database_with_icu_rules() : void
    {
        self::assertSame('CREATE DATABASE mydb ICU_RULES "&V << w <<< W"', create()->database('mydb')->icuRules('&V << w <<< W')->toSql());
    }

    public function test_create_database_with_is_template() : void
    {
        self::assertSame('CREATE DATABASE mydb IS_TEMPLATE 1', create()->database('mydb')->isTemplate(true)->toSql());
    }

    public function test_create_database_with_locale() : void
    {
        self::assertSame('CREATE DATABASE mydb LOCALE "en_US.UTF-8"', create()->database('mydb')->locale('en_US.UTF-8')->toSql());
    }

    public function test_create_database_with_locale_provider() : void
    {
        self::assertSame('CREATE DATABASE mydb LOCALE_PROVIDER icu', create()->database('mydb')->localeProvider('icu')->toSql());
    }
    ...
    {
        self::assertSame('CREATE DATABASE mydb OID 12345', create()->database('mydb')->oid(12345)->toSql());
    }

    public function test_create_database_with_owner() : void
    {
        self::assertSame('CREATE DATABASE mydb OWNER admin', create()->database('mydb')->owner('admin')->toSql());
    }

    public function test_create_database_with_strategy() : void
    {
        self::assertSame('CREATE DATABASE mydb STRATEGY wal_log', create()->database('mydb')->strategy('wal_log')->toSql());
    }

    public function test_create_database_with_tablespace() : void
    {
        self::assertSame('CREATE DATABASE mydb TABLESPACE fast_ssd', create()->database('mydb')->tablespace('fast_ssd')->toSql());
    }

    public function test_create_database_with_template() : void
    {
        self::assertSame('CREATE DATABASE mydb TEMPLATE template0', create()->database('mydb')->template('template0')->toSql());
    }
}
