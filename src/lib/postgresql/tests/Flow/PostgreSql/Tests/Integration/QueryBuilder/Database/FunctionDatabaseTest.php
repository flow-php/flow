...
final class FunctionDatabaseTest extends PostgreSqlTestCase
{
    ...
    public function test_alter_function_rename(): void
    {
        ...
        $this
            ...
            ->client()
            ->execute(
                alter()->function(self::FUNCTION_NAME)->arguments()->renameTo(self::FUNCTION_NAME_RENAMED)->toSql(),
            );

        static::assertFalse($this->functionExists(self::FUNCTION_NAME));
        static::assertTrue($this->functionExists(self::FUNCTION_NAME_RENAMED));
    }
    ...
    public function test_alter_function_set_volatility(): void
    {
        ...
        $this
            ->pgsqlContext()
            ->client()
            ->execute(alter()->function(self::FUNCTION_NAME)->arguments()->immutable()->toSql());

        static::assertTrue($this->functionExists(self::FUNCTION_NAME));
    }
    ...
    public function test_create_function_with_arguments(): void
    {
        ...
        $row = $this
            ->pgsqlContext()
            ->client()
            ->fetchSingle(select(func(self::FUNCTION_NAME, [literal(10), literal(5)])->as('result'))->toSql());
        static::assertSame(15, $row['result']);
    }
    ...
    public function test_create_function_with_default_argument(): void
    {
        ...
        $row = $this
            ->pgsqlContext()
            ->client()
            ->fetchSingle(select(func(self::FUNCTION_NAME, [literal(5)])->as('result'))->toSql());
        static::assertSame(15, $row['result']);

        $row = $this
            ->pgsqlContext()
            ->client()
            ->fetchSingle(select(func(self::FUNCTION_NAME, [literal(5), literal(3)])->as('result'))->toSql());
        static::assertSame(8, $row['result']);
    }
    ...
    public function test_create_or_replace_function(): void
    {
        ...
        $row = $this
            ->pgsqlContext()
            ->client()
            ->fetchSingle(select(func(self::FUNCTION_NAME)->as('result'))->toSql());
        static::assertSame(1, $row['result']);
        ...
        $row = $this
            ...
            ->client()
            ->fetchSingle(select(func(self::FUNCTION_NAME)->as('result'))->toSql());
        static::assertSame(2, $row['result']);
    }
    ...
    public function test_create_simple_function(): void
    {
        ...
        $row = $this
            ...
            ->client()
            ->fetchSingle(select(func(self::FUNCTION_NAME)->as('result'))->toSql());
        static::assertSame(42, $row['result']);
    }
    ...
    public function test_drop_function(): void
    {
        ...
        $this->pgsqlContext()->client()->execute(drop()->function(self::FUNCTION_NAME)->toSql());
    ...
    public function test_drop_function_if_exists(): void
    {
        ...
        $this->pgsqlContext()->client()->execute(drop()->function(self::FUNCTION_NAME)->ifExists()->toSql());
    }
    ...
    public function test_drop_function_with_arguments(): void
    {
        ...
        $this
            ->pgsqlContext()
            ->client()
            ->execute(drop()->function(self::FUNCTION_NAME)->arguments(func_arg(column_type_integer()))->toSql());
