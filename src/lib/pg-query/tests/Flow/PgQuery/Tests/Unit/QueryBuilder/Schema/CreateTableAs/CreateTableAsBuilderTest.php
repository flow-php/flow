...
namespace Flow\PgQuery\Tests\Unit\QueryBuilder\Schema\CreateTableAs;

use Flow\PgQuery\Protobuf\AST\{CreateTableAsStmt, ObjectType};
use Flow\PgQuery\QueryBuilder\Expression\RawExpression;
use Flow\PgQuery\QueryBuilder\Schema\CreateTableAs\CreateTableAsBuilder;
