...
use Flow\PgQuery\QueryBuilder\Table\{AliasedTable, DerivedTable};
...
final class DerivedTableTest extends TestCase
{
    ...
    public function test_converts_derived_table_to_ast() : void
    {
        ...
        self::assertInstanceOf(\Flow\PgQuery\Protobuf\AST\Alias::class, $alias);
    ...
    public function test_converts_derived_table_with_column_aliases_to_ast() : void
    {
        ...
        self::assertInstanceOf(\Flow\PgQuery\Protobuf\AST\PBString::class, $col1);
        self::assertSame('id', $col1->getSval());

        $col2 = $colnames[1]->getString();
        self::assertInstanceOf(\Flow\PgQuery\Protobuf\AST\PBString::class, $col2);
