...
namespace Flow\PgQuery\Tests\Unit\QueryBuilder\Schema\Truncate;

use Flow\PgQuery\Protobuf\AST\{DropBehavior, TruncateStmt};
use Flow\PgQuery\QueryBuilder\Schema\Truncate\TruncateBuilder;
