...
namespace Flow\PgQuery\Tests\Unit\QueryBuilder\Merge;

use Flow\PgQuery\{ParsedQuery, Parser};
use Flow\PgQuery\Protobuf\AST\{MergeStmt, Node, RawStmt, SelectStmt};
...
use Flow\PgQuery\QueryBuilder\Merge\{MergeActionType, MergeBuilder, MergeFinalStep, MergeMatchKind, MergeWhenClauseData, MergeWhenMatched, MergeWhenNotMatched};
