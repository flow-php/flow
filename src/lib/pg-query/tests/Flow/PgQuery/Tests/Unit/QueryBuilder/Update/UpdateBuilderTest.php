...
namespace Flow\PgQuery\Tests\Unit\QueryBuilder\Update;

use Flow\PgQuery\{ParsedQuery, Parser};
use Flow\PgQuery\Protobuf\AST\{Node, RawStmt, UpdateStmt};
...
final class UpdateBuilderTest extends TestCase
{
    ...
    public function test_from_ast_throws_on_empty_target_list() : void
    {
        ...
        $rangeVar = new \Flow\PgQuery\Protobuf\AST\RangeVar(['relname' => 'users']);
