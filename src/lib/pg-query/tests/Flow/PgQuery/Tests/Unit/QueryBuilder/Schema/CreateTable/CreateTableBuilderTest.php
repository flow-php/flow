...
namespace Flow\PgQuery\Tests\Unit\QueryBuilder\Schema\CreateTable;

use Flow\PgQuery\Protobuf\AST\{CreateStmt, OnCommitAction, PartitionStrategy};
...
use Flow\PgQuery\QueryBuilder\Schema\CreateTable\CreateTableBuilder;
