...
namespace Flow\PgQuery\Tests\Unit\QueryBuilder\Schema\Domain;

use function Flow\PgQuery\DSL\sql_type_text;
use Flow\PgQuery\Protobuf\AST\{AlterDomainStmt, ConstrType, CreateDomainStmt, DropBehavior, DropStmt, ObjectType};
use Flow\PgQuery\QueryBuilder\Schema\Domain\{AlterDomainBuilder, CreateDomainBuilder, DropDomainBuilder};
