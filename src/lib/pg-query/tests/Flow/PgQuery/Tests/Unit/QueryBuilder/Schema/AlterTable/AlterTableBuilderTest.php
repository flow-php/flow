...
namespace Flow\PgQuery\Tests\Unit\QueryBuilder\Schema\AlterTable;

use Flow\PgQuery\Protobuf\AST\{AlterTableStmt, AlterTableType, DropBehavior, ObjectType};
use Flow\PgQuery\QueryBuilder\Schema\AlterTable\AlterTableBuilder;
use Flow\PgQuery\QueryBuilder\Schema\{ColumnDefinition, DataType};
use Flow\PgQuery\QueryBuilder\Schema\Constraint\{ForeignKeyConstraint, PrimaryKeyConstraint, UniqueConstraint};
