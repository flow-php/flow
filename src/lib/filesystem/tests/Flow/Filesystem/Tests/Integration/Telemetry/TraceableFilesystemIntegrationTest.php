...
final class TraceableFilesystemIntegrationTest extends TestCase
{
    ...
    public function test_complete_read_write_workflow_produces_lifecycle_spans() : void
    {
        ...
        self::assertContains('stream.write', $spanNames);
        self::assertContains('stream.read', $spanNames);
        ...
        $destinationSpan = $this->findSpanByName($spans, 'stream.write');
        ...
        $sourceSpan = $this->findSpanByName($spans, 'stream.read');
    ...
    public function test_multiple_appends_create_single_span_with_cumulative_metrics() : void
    {
        ...
        self::assertSame('stream.write', $destinationSpan->name());
