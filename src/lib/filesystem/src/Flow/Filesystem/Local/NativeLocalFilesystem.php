...
use Flow\Filesystem\{DestinationStream, FileStatus, Filesystem, Mount, Path, Path\Filter, SourceStream};
...
{
    public function __construct(private Mount $mount = new Mount('file'))
    {
    }
