...
final class PostgreSqlBulkInsertTest extends PostgreSqlIntegrationTestCase
{
    public function test_inserts_multiple_rows_at_once() : void
    {
        ...
        Bulk::create()->insert(
            ...
            $table,
            new BulkData([
                ['id' => $id1 = \Flow\ETL\UniqueFactory::string(10), 'age' => 20, 'name' => 'Name One', 'description' => 'Description One', 'active' => false, 'updated_at' => $date1->format(\DateTimeInterface::ATOM), 'tags' => \json_encode(['a', 'b', 'c'])],
