...
final class SqliteBulkInsertTest extends SqliteIntegrationTestCase
{
    public function test_inserts_multiple_rows_at_once() : void
    {
        ...
        Bulk::create()->insert(
            ...
            $table,
            new BulkData([
                ['id' => $id1 = \Flow\ETL\DSL\generate_random_string(10), 'age' => 20, 'name' => 'Name One', 'description' => 'Description One', 'active' => false, 'updated_at' => $date1 = new \DateTime(), 'tags' => \json_encode(['a', 'b', 'c'])],
