...
final class DefinitionConverterTest extends TestCase
{
    ...
    public function test_optional(int $level, mixed $value, mixed $result, ?string $exceptionMessage = null): void
    {
        ...
        static::assertSame(1, $repetitions->maxDefinitionLevel());
    ...
    public function test_optional_optional(
        int $level,
        mixed $value,
        mixed $result,
        ...
        static::assertSame(2, $repetitions->maxDefinitionLevel());
    ...
    public function test_optional_repeated_optional(
        int $level,
        mixed $value,
        mixed $result,
        ?string $exceptionMessage = null,
        ...
        static::assertSame(3, $repetitions->maxDefinitionLevel());
    ...
    public function test_optional_repeated_optional_repeated_optional(
        int $level,
        mixed $value,
        mixed $result,
        ?string $exceptionMessage = null,
        ...
        static::assertSame(5, $repetitions->maxDefinitionLevel());
    ...
    #[TestWith([7, 1, [[[1]]]])]
    public function test_optional_repeated_optional_repeated_optional_repeated_optional(
        int $level,
        mixed $value,
        mixed $result,
        ?string $exceptionMessage = null,
        ...
        static::assertSame(7, $repetitions->maxDefinitionLevel());
    ...
    #[TestWith([2, 'value', ['value']])]
    public function test_optional_repeated_required(
        int $level,
        mixed $value,
        mixed $result,
        ?string $exceptionMessage = null,
    ...
    public function test_optional_required(
        int $level,
        mixed $value,
        mixed $result,
        ?string $exceptionMessage = null,
    ...
    public function test_required(int $level, mixed $value, mixed $result, ?string $exceptionMessage = null): void
    {
        ...
        static::assertSame(0, $repetitions->maxDefinitionLevel());
    ...
    #[TestWith([0, null, new NullLevel(0)])]
    #[TestWith([1, 'value', 'value'])]
    public function test_required_optional(
        int $level,
        mixed $value,
        mixed $result,
        ?string $exceptionMessage = null,
    ...
    #[TestWith([1, null, [[]]])]
    #[TestWith([2, 1, [[1]]])]
    public function test_required_repeated_required_repeated_required(
        int $level,
        mixed $value,
        mixed $result,
        ?string $exceptionMessage = null,
    ...
    #[TestWith([0, null, null, 'Value cannot be null for level "0" and max definition level "0"'])]
    #[TestWith([0, 'value', 'value'])]
    public function test_required_required(
        int $level,
        mixed $value,
        mixed $result,
        ?string $exceptionMessage = null,
