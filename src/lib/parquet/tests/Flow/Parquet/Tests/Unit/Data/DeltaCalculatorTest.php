...
final class DeltaCalculatorTest extends TestCase
{
    ...
    public function test_calculate_delta_sequential_large_values(): void
    {
        ...
        static::assertSame([1, 1, 1], $deltas);
    }

    public function test_calculate_delta_with_negative_values(): void
    {
        static::assertSame(-5, $this->calculator->calculateDelta(-10, -15));
        static::assertSame(5, $this->calculator->calculateDelta(-15, -10));
        static::assertSame(10, $this->calculator->calculateDelta(-5, 5));
        static::assertSame(-10, $this->calculator->calculateDelta(5, -5));
    }
    ...
    public function test_calculate_delta_with_normal_values(): void
    {
        static::assertSame(5, $this->calculator->calculateDelta(10, 15));
        static::assertSame(-5, $this->calculator->calculateDelta(15, 10));
        static::assertSame(0, $this->calculator->calculateDelta(100, 100));
        static::assertSame(1, $this->calculator->calculateDelta(0, 1));
        static::assertSame(-1, $this->calculator->calculateDelta(1, 0));
    }

    public function test_calculate_delta_with_overflow_wrapping(): void
    {
        static::assertSame(1001, $this->calculator->calculateDelta(PHP_INT_MAX, PHP_INT_MIN + 1000));
    }

    public function test_calculate_delta_with_underflow_wrapping(): void
    {
        static::assertSame(-1001, $this->calculator->calculateDelta(PHP_INT_MIN, PHP_INT_MAX - 1000));
    }

    public function test_calculate_delta_with_zero(): void
    {
        static::assertSame(10, $this->calculator->calculateDelta(0, 10));
        static::assertSame(-10, $this->calculator->calculateDelta(0, -10));
        static::assertSame(-5, $this->calculator->calculateDelta(5, 0));
        static::assertSame(5, $this->calculator->calculateDelta(-5, 0));
    }
    ...
    public function test_calculate_deltas_preserves_correct_delta_values(): void
    {
        ...
        static::assertSame(1001, $deltas[0]);
        static::assertSame(-1501, $deltas[1]);
    }
    ...
    public function test_calculate_deltas_with_array(): void
    {
        ...
        static::assertSame($expected, $deltas);
    }
    ...
    public function test_calculate_relative_delta_edge_cases_with_overflow(): void
    {
        ...
        foreach ($testCases as $case) {
            ...
            static::assertGreaterThanOrEqual(
                PHP_INT_MIN,
                $result,
                "Result should be >= PHP_INT_MIN for: {$case['description']}",
            );
            static::assertLessThanOrEqual(
                PHP_INT_MAX,
                $result,
                "Result should be <= PHP_INT_MAX for: {$case['description']}",
            );
        }
    }
    ...
    public function test_calculate_relative_delta_max_to_min_transition(): void
    {
        ...
        static::assertSame(-1, $relativeDelta);
    }
    ...
    public function test_calculate_relative_delta_with_extreme_overflow_negative(): void
    {
        ...
        static::assertSame(1001, $this->calculator->calculateRelativeDelta($delta, $minDelta));
    }
    ...
    {
        static::assertSame(20, $this->calculator->calculateRelativeDelta(10, -10));
        static::assertSame(10, $this->calculator->calculateRelativeDelta(0, -10));
        static::assertSame(0, $this->calculator->calculateRelativeDelta(-10, -10));
        static::assertSame(-5, $this->calculator->calculateRelativeDelta(-15, -10));
    }
    ...
    public function test_calculate_relative_delta_with_normal_values(): void
    {
        static::assertSame(0, $this->calculator->calculateRelativeDelta(10, 10));
        static::assertSame(5, $this->calculator->calculateRelativeDelta(15, 10));
        static::assertSame(-5, $this->calculator->calculateRelativeDelta(5, 10));
        static::assertSame(100, $this->calculator->calculateRelativeDelta(150, 50));
        static::assertSame(-50, $this->calculator->calculateRelativeDelta(-25, 25));
    }
    ...
    {
        static::assertSame(10, $this->calculator->calculateRelativeDelta(10, 0));
        static::assertSame(-10, $this->calculator->calculateRelativeDelta(-10, 0));
        static::assertSame(0, $this->calculator->calculateRelativeDelta(0, 0));
        static::assertSame(PHP_INT_MAX, $this->calculator->calculateRelativeDelta(PHP_INT_MAX, 0));
        static::assertSame(PHP_INT_MIN, $this->calculator->calculateRelativeDelta(PHP_INT_MIN, 0));
    }
    ...
    public function test_reconstruct_values_from_deltas(): void
    {
        ...
        static::assertSame($originalValues, $reconstructed);
    }
