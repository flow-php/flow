...
final class ScalarDictionaryBuilderTest extends TestCase
{
    ...
    public function test_alternating_pattern(): void
    {
        ...
        static::assertInstanceOf(Dictionary::class, $result);
        static::assertSame([1, 2], $result->dictionary);
        static::assertSame([0, 1, 0, 1, 0, 1, 0, 1], $result->indices);
    }
    ...
    public function test_boolean_values(): void
    {
        ...
        static::assertInstanceOf(Dictionary::class, $result);
        static::assertSame([true, false], $result->dictionary);
        static::assertSame([0, 1, 0, 1, 0], $result->indices);
    }
    ...
    public function test_duplicate_values_creates_indexed_dictionary(): void
    {
        ...
        static::assertInstanceOf(Dictionary::class, $result);
        static::assertSame([1, 2, 3, 4], $result->dictionary);
    ...
    public function test_edge_case_negative_values(): void
    {
        ...
        static::assertInstanceOf(Dictionary::class, $result);
        static::assertSame([-1, -2, 0], $result->dictionary);
    ...
    public function test_edge_case_zero_values(): void
    {
        ...
        static::assertInstanceOf(Dictionary::class, $result);
        static::assertSame([0], $result->dictionary);
    ...
    public function test_empty_strings(): void
    {
        ...
        static::assertInstanceOf(Dictionary::class, $result);
        static::assertSame(['', 'hello', 'world'], $result->dictionary);
        static::assertSame([0, 1, 0, 2, 0], $result->indices);
    }
    ...
    public function test_float_values(): void
    {
        ...
        static::assertInstanceOf(Dictionary::class, $result);
        static::assertSame([1.5, 2.5, 3.5], $result->dictionary);
    ...
    public function test_large_number_of_duplicates(): void
    {
        ...
        static::assertInstanceOf(Dictionary::class, $result);
        static::assertSame([42], $result->dictionary);
    ...
    public function test_maintains_first_occurrence_order(): void
    {
        ...
        static::assertInstanceOf(Dictionary::class, $result);
        static::assertSame([5, 2, 8, 1, 9], $result->dictionary);
    ...
    public function test_multiple_unique_values_creates_ordered_dictionary(): void
    {
        ...
        static::assertInstanceOf(Dictionary::class, $result);
        static::assertSame([1, 2, 3, 4, 5], $result->dictionary);
    ...
    public function test_single_boolean_value(): void
    {
        ...
        static::assertInstanceOf(Dictionary::class, $result);
        static::assertSame([true], $result->dictionary);
        static::assertSame([0, 0, 0], $result->indices);
    }
    ...
    public function test_special_characters_in_strings(): void
    {
        ...
        static::assertSame([0, 1, 0, 2], $result->indices);
    }
    ...
    public function test_string_values(): void
    {
        ...
        static::assertInstanceOf(Dictionary::class, $result);
        static::assertSame(['apple', 'banana', 'cherry'], $result->dictionary);
        static::assertSame([0, 1, 2, 1, 0], $result->indices);
    }
    ...
    public function test_unicode_strings(): void
    {
        ...
        static::assertInstanceOf(Dictionary::class, $result);
        static::assertSame(['héllo', 'wörld', '测试'], $result->dictionary);
        static::assertSame([0, 1, 0, 2], $result->indices);
    }
}
