...
final class RLEBitPackedPackerTest extends TestCase
{
    ...
    public static function pack_with_bit_width_provider(): Generator
    {
        ...
        yield 'mixed values for bit packing' => [
            4,
            [1, 2, 3, 4, 5, 6, 7, 8],
            'mixed values for bit packing with bit width',
        ];
    ...
    public static function pack_with_length_provider(): Generator
    {
        ...
        yield 'mixed values for bit packing' => [
            4,
            [1, 2, 3, 4, 5, 6, 7, 8],
            'mixed values for bit packing with length',
        ];
    ...
    protected function setUp(): void
    {
        ...
        $this->packer = new RLEBitPackedPacker($this->hybrid, ByteOrder::LITTLE_ENDIAN);
    }
    ...
    public function test_pack_large_array(): void
    {
        ...
        static::assertEquals($values, $decoded);
    }
    ...
    public function test_pack_with_bit_width(int $bitWidth, array $values, string $description): void
    {
        ...
        static::assertEquals($expectedBitWidth, $decodedBitWidth, 'Bit width should be prepended');
    ...
    public function test_pack_with_bit_width_empty_array(): void
    {
        ...
        $reader = new BinaryBufferReader($result);
        $decodedBitWidth = $reader->readVarInt();
        static::assertEquals(0, $decodedBitWidth);
    ...
    public function test_pack_with_bit_width_large_array(): void
    {
        ...
        $reader = new BinaryBufferReader($result);
        $decodedBitWidth = $reader->readVarInt();
        static::assertEquals(BitWidth::fromArray($values), $decodedBitWidth);
    ...
    public function test_pack_with_length(int $bitWidth, array $values, string $description): void
    {
        ...
        static::assertGreaterThan(0, $decodedLength, 'Length should be prepended and positive');

        $dataBuffer = '';
        $this->hybrid->encodeHybrid(new BinaryBufferWriter($dataBuffer), $bitWidth, $values);
        static::assertEquals(strlen($dataBuffer), $decodedLength, 'Length should match encoded data size');
    ...
    public function test_pack_with_length_empty_array(): void
    {
        ...
        $reader = new BinaryBufferReader($result);
        $decodedLength = decode_i32(ByteOrder::LITTLE_ENDIAN, $reader->readBytes(4))[0];
        static::assertGreaterThanOrEqual(0, $decodedLength);
    ...
    public function test_pack_with_length_large_array(): void
    {
        ...
        $reader = new BinaryBufferReader($result);
        $decodedLength = decode_i32(ByteOrder::LITTLE_ENDIAN, $reader->readBytes(4))[0];
        static::assertGreaterThan(0, $decodedLength);
