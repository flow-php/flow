...
final class FlatColumnValuesTest extends TestCase
{
    ...
    public function test_splitting_list_by_rows() : void
    {
        ...
        self::assertSame([0, 1, 0], $split[0]->repetitionLevels());
        self::assertSame([1, 2, 3], $split[0]->values());
        self::assertSame([3, 3, 3], $split[0]->definitionLevels());

        self::assertSame([0, 0, 1], $split[1]->repetitionLevels());
        self::assertSame([2, 3, 3], $split[1]->definitionLevels());
