...
final class DictionaryBuilderTest extends TestCase
{
    ...
    public static function byte_array_date_time_logical_types_provider(): \Generator
    {
        ...
        yield 'FIXED_LEN_BYTE_ARRAY with DATE logical type' => [
            PhysicalType::FIXED_LEN_BYTE_ARRAY,
            LogicalType::date(),
        ];
        yield 'FIXED_LEN_BYTE_ARRAY with TIME logical type' => [
            PhysicalType::FIXED_LEN_BYTE_ARRAY,
            LogicalType::time(),
        ];
        yield 'FIXED_LEN_BYTE_ARRAY with TIMESTAMP logical type' => [
            PhysicalType::FIXED_LEN_BYTE_ARRAY,
    ...
    public static function byte_array_string_logical_types_provider(): \Generator
    {
        ...
        yield 'FIXED_LEN_BYTE_ARRAY with STRING logical type' => [
            PhysicalType::FIXED_LEN_BYTE_ARRAY,
            LogicalType::string(),
        ];
        yield 'FIXED_LEN_BYTE_ARRAY with JSON logical type' => [
            PhysicalType::FIXED_LEN_BYTE_ARRAY,
            LogicalType::json(),
        ];
        yield 'FIXED_LEN_BYTE_ARRAY with BSON logical type' => [
            PhysicalType::FIXED_LEN_BYTE_ARRAY,
            LogicalType::bson(),
        ];
        yield 'FIXED_LEN_BYTE_ARRAY with UUID logical type' => [
            PhysicalType::FIXED_LEN_BYTE_ARRAY,
            LogicalType::uuid(),
        ];
        yield 'FIXED_LEN_BYTE_ARRAY with ENUM logical type' => [
            PhysicalType::FIXED_LEN_BYTE_ARRAY,
            LogicalType::enum(),
        ];
    }
    ...
    public function test_boolean_physical_type_with_all_same_values(): void
    {
        ...
        static::assertSame([0, 0, 0, 0], $result->indices);
    }
    ...
    public function test_byte_array_fixed_len_byte_array_with_string_logical_types(
        ...
        static::assertInstanceOf(Dictionary::class, $result);
        static::assertSame(['apple', 'banana', 'cherry', 'date'], $result->dictionary);
        static::assertSame([0, 1, 2, 1, 0, 3, 2], $result->indices);
    }
    ...
    public function test_int64_int32_physical_types_with_default_logical_types(
        ...
        static::assertInstanceOf(Dictionary::class, $result);
        static::assertSame([10, 20, 30, 40], $result->dictionary);
        static::assertSame([0, 1, 2, 1, 0, 3, 2], $result->indices);
    }
    ...
    public function test_large_string_values(): void
    {
        ...
        static::assertInstanceOf(Dictionary::class, $result);
        static::assertSame([$longString1, $longString2, $longString3], $result->dictionary);
    ...
    public function test_maintains_order_of_first_occurrence(): void
    {
        ...
        static::assertInstanceOf(Dictionary::class, $result);
        static::assertSame([3, 1, 2], $result->dictionary);
