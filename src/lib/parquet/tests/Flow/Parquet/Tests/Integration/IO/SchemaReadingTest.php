...
final class SchemaReadingTest extends TestCase
{
    ...
    public function test_reading_primitives_schema_ddl() : void
    {
        ...
        $schema = Schema::with(
            ...
            FlatColumn::string('json'), // files generated by python are storing json as strings
            FlatColumn::string('json_nullable'),
            ...
            FlatColumn::string('uuid'), // files generated by python are storing uuid as strings
            FlatColumn::string('uuid_nullable'),
