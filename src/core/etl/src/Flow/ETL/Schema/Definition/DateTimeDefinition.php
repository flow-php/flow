 ...
 */
final class DateTimeDefinition implements Definition
{
    ...
    public function matches(Entry $entry) : bool
    {
        ...
        return $entry->type() instanceof DateTimeType;
    }
    ...
    public function merge(Definition $definition) : Definition
    {
        ...
        if ($definition instanceof self || $definition instanceof DateDefinition || $definition instanceof TimeDefinition) {
            return new self(
                $this->ref,
