...
/**
 * @implements Definition<\DateTimeZone>
 */
final readonly class TimeZoneDefinition implements Definition
{
    ...
    public function matches(Entry $entry): bool
    {
        ...
        return $entry->type() instanceof TimeZoneType;
    }
    ...
    /**
     * @return class-string<Entry\TimeZoneEntry>
     */
    public function entryClass(): string
    {
        return Entry\TimeZoneEntry::class;
    }
}
