        ...
        try {
            ...
            if ($array === null || $path === null) {
                $context
                    ->functions()
                    ->invalidResult(
                        new InvalidArgumentException('ArrayPathExists function requires non-null array and path'),
                    );
            ...
            $context
                ->functions()
                ->invalidResult(new InvalidArgumentException('ArrayPathExists error: ' . $e->getMessage()));
