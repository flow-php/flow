...
/**
 * Records the references it sees - an effect outside the stream - and passes every row.
 */
final readonly class CollectRefs implements Node
{
    ...
    {
        return $children[0] === $this->input ? $this : new self($children[0], $this->references);
    }
