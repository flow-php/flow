 ...
 * Blocking is the worst case: the planner picks the buckets storage, and a resident one streams the left side
 * instead. Stage::physical prints the storage the plan was actually given.
 */
