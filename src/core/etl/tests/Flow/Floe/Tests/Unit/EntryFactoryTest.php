...
final class EntryFactoryTest extends TestCase
{
    ...
    {
        $entry = EntryInstantiator::forClass(IntegerEntry::class)->instantiate('id', 42, new IntegerDefinition('id'));
    ...
    {
        $entry = EntryInstantiator::forClass(StringEntry::class)->instantiate(
            'name',
            null,
