...
use function Flow\ETL\DSL\{type_enum};
...
use Flow\ETL\Tests\Unit\PHP\Type\Fixtures\{AnotherEnum, SomeEnum};
...
final class EnumTypeTest extends FlowTestCase
{
    ...
    public function test_casting_integer_to_enum() : void
    {
        ...
        $this->expectExceptionMessage('Can\'t cast "int" into "enum<Flow\ETL\Tests\Unit\PHP\Type\Caster\Fixtures\ColorsEnum>" type');
