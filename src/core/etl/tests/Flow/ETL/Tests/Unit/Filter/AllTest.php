...
final class AllTest extends TestCase
{
    ...
    {
        $filter = new All(new Callback(fn (Row $row) : bool => true), new Callback(fn (Row $row) : bool => true));
    ...
    {
        $filter = new All(new Callback(fn (Row $row) : bool => false), new Callback(fn (Row $row) : bool => false));
    ...
    {
        $filter = new All(new Callback(fn (Row $row) : bool => false));
