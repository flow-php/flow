...
use function Flow\ETL\DSL\{date_schema, datetime_schema, int_entry, string_schema, time_entry, time_schema};
use Flow\ETL\Exception\RuntimeException;
use Flow\ETL\Schema\Definition\BooleanDefinition;
use Flow\ETL\Schema\Definition\{DateTimeDefinition, TimeDefinition};
...
final class TimeDefinitionTest extends FlowTestCase
{
    ...
    public function test_does_not_match_entry_with_different_name() : void
    {
        ...
        self::assertFalse($def->matches(time_entry('other', '10:30:00')));
    }
    ...
    public function test_matches_entry_with_same_name_and_type() : void
    {
        ...
        self::assertTrue($def->matches(time_entry('duration', '10:30:00')));
    }
    ...
    public function test_merge_when_both_are_from_null() : void
    {
        ...
        self::assertInstanceOf(TimeDefinition::class, $merged);
    ...
    public function test_normalize() : void
    {
        ...
        self::assertSame('duration', $normalized['ref']);
    ...
    public function test_nullable_matches_any_entry_with_same_name() : void
    {
        ...
        self::assertTrue($def->matches(time_entry('col', null)));
    }
    ...
    public function test_rename() : void
    {
        ...
        self::assertSame('new_duration', $renamed->entry()->name());
        self::assertSame('duration', $def->entry()->name());
    }
    ...
    public function test_type_returns_time_type() : void
    {
        ...
        self::assertSame('time', $def->type()->toString());
    }
}
