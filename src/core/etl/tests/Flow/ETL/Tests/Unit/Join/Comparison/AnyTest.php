...
final class AnyTest extends FlowTestCase
{
    public function test_failure(): void
    {
        ...
        static::assertFalse((new Any($comparison1, $comparison2))->compare(row(['id' => 1]), row(['id' => 2])));
    }
    ...
    public function test_success(): void
    {
        ...
        static::assertTrue((new Any($comparison1, $comparison2))->compare(row(['id' => 1]), row(['id' => 2])));
    }
}
