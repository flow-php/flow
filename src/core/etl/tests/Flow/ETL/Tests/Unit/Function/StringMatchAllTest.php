...
final class StringMatchAllTest extends FlowTestCase
{
    ...
    {
        $result = ref('str')->matchAll('/(\w+)=(\d+)/')->eval(
    ...
    {
        $result = ref('str')->matchAll('/hello/i')->eval(
    ...
    {
        $result = ref('str')->matchAll('/(\w+)@(\w+\.\w+)/')->eval(
    ...
    {
        $result = ref('str')->matchAll('/hello/')->eval(
            row(str_entry('str', ''))
        );
    ...
    {
        $result = ref('str')->matchAll('/\w+/')->eval(
    ...
    {
        $result = ref('str')->matchAll('/^line\d+/m')->eval(
    ...
    {
        $result = ref('str')->matchAll('/\d+/')->eval(
    ...
    {
        $result = ref('str')->matchAll('/(?P<key>\w+)=(?P<value>\d+)/')->eval(
    ...
    {
        $result = ref('str')->matchAll('/foo/')->eval(
            row(str_entry('str', 'hello world'))
        );
    ...
    {
        $result = ref('str')->matchAll(ref('pattern'))->eval(
            row(
    ...
    {
        $result = ref('str')->matchAll('/\d+\.\d+/')->eval(
    ...
    {
        $result = ref('str')->matchAll('/\w\w/')->eval(
    ...
    {
        $result = ref('str')->matchAll('/^test/')->eval(
    ...
    {
        $result = ref('str')->matchAll('/[aeiou]/')->eval(
            row(str_entry('str', 'hello world'))
        );
    ...
    {
        $result = ref('str')->matchAll('/नमस्कार/u')->eval(
            row(str_entry('str', 'hello world'))
        );
    ...
    {
        $result = ref('str')->matchAll('/\S+/u')->eval(
    ...
    {
        $result = ref('str')->matchAll('/\s+/')->eval(
    ...
    {
        $result = ref('str')->matchAll('/\p{Emoji}/u')->eval(
    ...
    {
        $result = ref('str')->matchAll('/\btest\b/')->eval(
