...
final class HighResolutionTimeTest extends FlowTestCase
{
    public function test_constructor_initializes_correctly(): void
    {
        ...
        static::assertSame([123, 456789000], $time->toArray());
        static::assertEquals(123.456789, $time->toSeconds());
    }
    ...
    public function test_diff_when_nanoseconds_need_adjustment(): void
    {
        ...
        static::assertSame([-1, 800000000], $diff->toArray());
        static::assertEqualsWithDelta(-0.2, $diff->toSeconds(), 1e-9);
    }
    ...
    public function test_diff_with_no_difference(): void
    {
        ...
        static::assertSame([0, 0], $diff->toArray());
        static::assertEquals(0.0, $diff->toSeconds());
    }
    ...
    public function test_diff_with_positive_difference(): void
    {
        ...
        static::assertSame([1, 600000000], $diff->toArray());
        static::assertEqualsWithDelta(1.6, $diff->toSeconds(), 1e-9);
    }

    public function test_now_creates_current_time_instance(): void
    {
        $time = HighResolutionTime::now();
        static::assertInstanceOf(HighResolutionTime::class, $time);
    }
