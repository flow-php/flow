...
use function Flow\ETL\DSL\{date_entry, date_schema, datetime_schema, int_entry, string_schema, time_schema};
use Flow\ETL\Exception\RuntimeException;
use Flow\ETL\Schema\Definition\BooleanDefinition;
use Flow\ETL\Schema\Definition\{DateDefinition, DateTimeDefinition};
...
final class DateDefinitionTest extends FlowTestCase
{
    ...
    public function test_does_not_match_entry_with_different_name() : void
    {
        ...
        self::assertFalse($def->matches(date_entry('other', '2024-01-15')));
    }
    ...
    public function test_matches_entry_with_same_name_and_type() : void
    {
        ...
        self::assertTrue($def->matches(date_entry('created_at', '2024-01-15')));
    }
    ...
    public function test_merge_when_both_are_from_null() : void
    {
        ...
        self::assertInstanceOf(DateDefinition::class, $merged);
    ...
    public function test_nullable_matches_any_entry_with_same_name() : void
    {
        ...
        self::assertTrue($def->matches(date_entry('col', null)));
    }
    ...
    public function test_type_returns_date_type() : void
    {
        ...
        self::assertSame('date', $def->type()->toString());
    }
}
