...
final class NativePHPHashTest extends FlowTestCase
{
    ...
    {
        static::assertSame('6c78e0e3bd51d358d01e758642b85fb8', NativePHPHash::xxh128('test'));
    }

    public function test_hashing_string_using_xxh128_by_default(): void
    {
        static::assertSame('6c78e0e3bd51d358d01e758642b85fb8', (new NativePHPHash())->hash('test'));
    }
