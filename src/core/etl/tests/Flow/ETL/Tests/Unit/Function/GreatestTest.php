...
final class GreatestTest extends FlowTestCase
{
    ...
    {
        static::assertSame(20, greatest(null, 20, ref('int'))->eval(row(int_entry('int', 4)), flow_context()));
    }

    public function test_null_only_when_every_argument_is_null(): void
    {
        static::assertNull(greatest(null, null)->eval(row(int_entry('int', 4)), flow_context()));
    }
