...
final class CollapseWhitespaceTest extends FlowTestCase
{
    ...
    {
        $result = ref('str')->collapseWhitespace()->eval(row(str_entry('str', '')), flow_context());
    ...
    {
        $result = ref('str')->collapseWhitespace()->eval(row(str_entry('str', '   Hello world   ')), flow_context());
    ...
    public function test_mixed_whitespace_types(): void
    {
        $result = ref('str')
            ->collapseWhitespace()
            ->eval(row(str_entry('str', "Hello\t\tworld\n\ntest")), flow_context());
    ...
    public function test_multiple_spaces_between_words(): void
    {
        $result = ref('str')
            ->collapseWhitespace()
            ->eval(row(str_entry('str', 'Hello     world     test')), flow_context());
    ...
    {
        $result = ref('str')->collapseWhitespace()->eval(row(str_entry('str', 'Hello world test')), flow_context());
    ...
    {
        $result = ref('str')->collapseWhitespace()->eval(row(str_entry('str', 'Hello')), flow_context());
