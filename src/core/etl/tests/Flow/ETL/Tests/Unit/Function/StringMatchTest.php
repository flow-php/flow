...
final class StringMatchTest extends FlowTestCase
{
    ...
    {
        $result = ref('str')->stringMatch('/foo/')->eval(row(str_entry('str', 'hello world')), flow_context());
    ...
    {
        $result = ref('str')->stringMatch('/hello/')->eval(row(str_entry('str', null)), flow_context());
    ...
    {
        $result = ref('str')->stringMatch('/hello/')->eval(row(str_entry('str', 'hello world')), flow_context());
    ...
    public function test_with_scalar_function_parameter(): void
    {
        $result = ref('str')
            ->stringMatch(ref('pattern'))
            ->eval(row(str_entry('str', 'hello world'), str_entry('pattern', '/world/')), flow_context());
