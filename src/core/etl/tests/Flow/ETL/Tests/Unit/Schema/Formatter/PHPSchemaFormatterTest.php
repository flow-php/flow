...
final class PHPSchemaFormatterTest extends FlowTestCase
{
    ...
    {
        static::assertEquals('\\Flow\\ETL\\DSL\\schema();', (new PHPSchemaFormatter())->format(schema()));
    }
    ...
    public function test_formatting_enum_schema(): void
    {
        static::assertEquals(<<<'PHP'
            ...
            PHP, (new PHPSchemaFormatter())->format(schema(enum_schema(
            'enum',
    ...
    public function test_formatting_float_schema(): void
    {
        static::assertEquals(<<<'PHP'
            ...
            PHP, (new PHPSchemaFormatter())->format(schema(float_schema('float', nullable: false, metadata: null))));
    }
    ...
    public function test_formatting_list_schema(): void
    {
        static::assertEquals(<<<'PHP'
            ...
            PHP, (new PHPSchemaFormatter())->format(schema(list_schema('list', type: type_list(type_integer())))));
    }
    ...
    public function test_formatting_map_schema(): void
    {
        static::assertEquals(<<<'PHP'
            ...
            PHP, (new PHPSchemaFormatter())->format(schema(map_schema(
            'map',
    ...
    public function test_formatting_simple_schema(): void
    {
        static::assertEquals(<<<PHP
            \\Flow\\ETL\\DSL\\schema(
                ...
                \\Flow\\ETL\\DSL\\html_element_schema("html_element", nullable: true, metadata: \\Flow\\ETL\\DSL\\schema_metadata()),
            );
            PHP, (new PHPSchemaFormatter())->format(schema(
            ...
            html_element_schema('html_element', nullable: true),
        )));
    }
    ...
    public function test_formatting_simple_schema_with_metadata(): void
    {
        static::assertEquals(<<<'PHP'
            ...
            PHP, (new PHPSchemaFormatter())->format(schema(int_schema(
            'id',
            nullable: false,
    ...
    public function test_formatting_structure_schema(): void
    {
        static::assertEquals(<<<'PHP'
            ...
            PHP, (new PHPSchemaFormatter())->format(schema(structure_schema('structure', type_structure([
            'int' => type_optional(type_integer()),
            'string' => type_optional(type_string()),
        ])))));
    }
}
