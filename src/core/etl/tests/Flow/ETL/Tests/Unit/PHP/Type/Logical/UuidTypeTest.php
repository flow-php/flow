...
use function Flow\ETL\DSL\{type_uuid};
...
final class UuidTypeTest extends FlowTestCase
{
    ...
    {
        yield [new \Flow\ETL\PHP\Value\Uuid('49e952c8-80ec-4910-a1d6-a19bd46b163d')];
    }
    ...
    {
        self::assertEquals(
            new \Flow\ETL\PHP\Value\Uuid('6c2f6e0e-8d8e-4e9e-8f0e-5a2d9c1c4f6e'),
    ...
    {
        self::assertInstanceOf(\Flow\ETL\PHP\Value\Uuid::class, type_uuid()->assert($value));
    }
