...
final class FlowTypeFormatterTest extends FlowTestCase
{
    ...
    {
        self::assertEquals('\\Flow\\ETL\\DSL\\type_array(nullable: false)', (new TypeFormatter())->format(type_array()));
        self::assertEquals('\\Flow\\ETL\\DSL\\type_array(nullable: true)', (new TypeFormatter())->format(type_array(true)));
    }
