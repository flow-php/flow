...
use function Flow\ETL\DSL\{float_schema, int_entry, int_schema, str_entry, string_schema};
use Flow\ETL\Exception\RuntimeException;
use Flow\ETL\Schema\Definition\BooleanDefinition;
use Flow\ETL\Schema\Definition\{FloatDefinition, IntegerDefinition};
...
final class IntegerDefinitionTest extends FlowTestCase
{
    ...
    public function test_does_not_match_entry_with_different_name() : void
    {
        ...
        self::assertFalse($def->matches(int_entry('other', 1)));
    }
    ...
    public function test_does_not_match_entry_with_different_type() : void
    {
        ...
        self::assertFalse($def->matches(str_entry('col', 'value')));
    }
    ...
    public function test_matches_entry_with_same_name_and_type() : void
    {
        ...
        self::assertTrue($def->matches(int_entry('id', 1)));
    }
    ...
    public function test_merge_when_both_are_from_null() : void
    {
        ...
        self::assertInstanceOf(IntegerDefinition::class, $merged);
    ...
    public function test_nullable_matches_any_entry_with_same_name() : void
    {
        ...
        self::assertTrue($def->matches(int_entry('col', null)));
    }
    ...
    public function test_type_returns_integer_type() : void
    {
        ...
        self::assertSame('integer', $def->type()->toString());
    }
}
