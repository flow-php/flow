...
final class IntegerDefinitionTest extends FlowTestCase
{
    ...
    {
        $merged = int_schema('col', false)->merge(null_schema('col'));
    ...
    {
        $merged = null_schema('col')->merge(int_schema('col', false));
    ...
    {
        $merged = int_schema('col')->merge(new UnionDefinition('col', type_union(type_integer(), type_boolean())));
    ...
    public function test_merge_with_union_not_containing_this_type_falls_back_to_string(): void
    {
        static::assertSame(
            'string',
            int_schema('col')
                ->merge(new UnionDefinition('col', type_union(type_boolean(), type_string())))
                ->type()
                ->toString(),
        );
    }
