...
use function Flow\ETL\DSL\{html_element_entry, html_element_schema, int_entry, string_schema};
use Flow\ETL\Exception\RuntimeException;
use Flow\ETL\Schema\Definition\{BooleanDefinition, HTMLElementDefinition};
...
final class HTMLElementDefinitionTest extends FlowTestCase
{
    ...
    public function test_does_not_match_entry_with_different_name() : void
    {
        ...
        self::assertFalse($def->matches(html_element_entry('other', '<div>content</div>')));
    }
    ...
    public function test_matches_entry_with_same_name_and_type() : void
    {
        ...
        self::assertTrue($def->matches(html_element_entry('element', '<div>content</div>')));
    }
    ...
    public function test_merge_when_both_are_from_null() : void
    {
        ...
        self::assertInstanceOf(HTMLElementDefinition::class, $merged);
    ...
    public function test_nullable_matches_any_entry_with_same_name() : void
    {
        ...
        self::assertTrue($def->matches(html_element_entry('col', null)));
    }
    ...
    public function test_type_returns_html_element_type() : void
    {
        ...
        self::assertSame('html_element', $def->type()->toString());
    }
}
