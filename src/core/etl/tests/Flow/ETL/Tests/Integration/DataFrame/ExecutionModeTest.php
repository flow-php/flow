...
use function Flow\ETL\DSL\execution_strict;
...
final class ExecutionModeTest extends FlowTestCase
{
    public function test_lenient_mode_allows_multiple_errors(): void
    {
        ...
        static::assertNull($result[1]['upper']);
        static::assertFalse($result[1]['starts_h']);
        static::assertNull($result[1]['value_int']);
        static::assertFalse($result[1]['contains_o']);
    }
    ...
    public function test_lenient_mode_with_invalid_data_continues_processing(): void
    {
        ...
        static::assertNull($result[1]['name_upper']);
        static::assertFalse($result[1]['starts_with_j']);
        static::assertNull($result[2]['value_int']);
    }
