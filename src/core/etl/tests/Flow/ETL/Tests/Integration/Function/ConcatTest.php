...
use function Flow\ETL\DSL\{array_get, concat, concat_ws, from_array, lit, ref, to_memory};
...
final class ConcatTest extends FlowTestCase
{
    ...
    public function test_concat_ws_on_non_string_value() : void
    {
        (data_frame())
            ->read(
                from_array(
    ...
    public function test_concat_ws_on_nulls() : void
    {
        (data_frame())
            ->read(
                from_array(
    ...
    public function test_concat_ws_with_separator() : void
    {
        (data_frame())
            ->read(
                from_array(
