...
STRING,
    ...
    {
        self::assertTrue((new LocalFilesystem())->exists(new Path(__DIR__)));
        self::assertFalse((new LocalFilesystem())->exists(new Path(__DIR__ . '/not_existing_directory')));
    }

    public function test_fie_exists() : void
    {
        self::assertTrue((new LocalFilesystem())->exists(new Path(__FILE__)));
        self::assertFalse((new LocalFilesystem())->exists(new Path(__DIR__ . '/not_existing_file.php')));
    }

    public function test_file_pattern_exists() : void
    {
        self::assertTrue((new LocalFilesystem())->exists(new Path(__DIR__ . '/**/*.txt')));
        self::assertFalse((new LocalFilesystem())->exists(new Path(__DIR__ . '/**/*.pdf')));
    }
