...
final class PartitionedSourceMother
{
    ...
    /**
     * One row per partition. The double ignores Scan::$pathFilter, so only a Filter node the planner kept can
     * drop the other partition's row.
     */
    public static function yearMonth(): RecordingScanExtractor
    {
        return (new RecordingScanExtractor(
