...
- 📜 [Documentation](https://flow-php.com/documentation/components/adapters/logger/)
- ➡️ [Installation](https://flow-php.com/documentation/installation/packages/etl-adapter-logger/)
