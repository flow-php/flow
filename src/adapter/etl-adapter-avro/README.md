...
- 📜 [Documentation](https://flow-php.com/documentation/components/adapters/avro/)
- ➡️ [Installation](https://flow-php.com/documentation/installation/packages/etl-adapter-avro/)
