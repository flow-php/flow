...
final class LineChartTest extends TestCase
{
    public function test_collecting_data_from_rows() : void
    {
        ...
        $chart = new LineChart(ref('Date'), [ref('Revenue'), ref('CM'), ref('Ads Spends'), ref('Storage Costs'), ref('Shipping Costs')]);
    ...
    public function test_setting_option_for_non_existing_dataset() : void
    {
        ...
        $chart = new LineChart(ref('Date'), [ref('Revenue'), ref('Ads Spends'), ref('Storage Costs'), ref('Shipping Costs')]);
