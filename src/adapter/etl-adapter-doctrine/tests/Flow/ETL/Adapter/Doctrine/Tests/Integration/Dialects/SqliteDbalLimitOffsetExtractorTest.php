...
final class SqliteDbalLimitOffsetExtractorTest extends IntegrationTestCase
{
    ...
    public function test_extracting_entire_table_using_qb_with_maximum_set_on_query() : void
    {
        ...
        self::assertSame(1, $this->sqliteDatabaseContext->numberOfExecutedSelectQueries());
        self::assertCount(5, $rows);
    ...
    public function test_extracting_entire_table_with_group_by() : void
    {
        ...
        for ($i = 1; $i <= 10; $i++) {
            $this->sqliteDatabaseContext->insert(
                $table,
                [
                    'id' => $i,
                    'name' => 'name_' . $i,
