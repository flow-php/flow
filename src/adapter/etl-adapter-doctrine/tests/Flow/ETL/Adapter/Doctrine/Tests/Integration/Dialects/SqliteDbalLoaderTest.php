...
final class SqliteDbalLoaderTest extends IntegrationTestCase
{
    public function test_delete_non_existent_rows(): void
    {
        ...
        static::assertEquals(2, $this->sqliteDatabaseContext->tableCount($table));
    ...
    public function test_delete_rows_using_existing_connection(): void
    {
        ...
        static::assertEquals(3, $this->sqliteDatabaseContext->tableCount($table));
    ...
    public function test_delete_with_composite_keys(): void
    {
        ...
        static::assertEquals(4, $this->sqliteDatabaseContext->tableCount($table));
    ...
    public function test_inserts_empty_rows(): void
    {
        ...
        static::assertEquals(0, $this->sqliteDatabaseContext->tableCount($table));
    }
    ...
    public function test_inserts_multiple_rows_at_once_using_existing_connection(): void
    {
        ...
        static::assertEquals(3, $this->sqliteDatabaseContext->tableCount($table));
        static::assertEquals(1, $this->sqliteDatabaseContext->numberOfExecutedInsertQueries());
    }
    ...
    public function test_inserts_new_rows_and_skip_already_existed(): void
    {
        ...
        data_frame()
            ...
            ->load(to_dbal_table_insert(
                ...
                $table,
                SqliteInsertOptions::new()->skipConflicts(),
            ))
            ->run();
