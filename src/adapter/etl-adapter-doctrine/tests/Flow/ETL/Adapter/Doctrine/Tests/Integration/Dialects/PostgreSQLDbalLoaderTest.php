...
use function Flow\ETL\Adapter\Doctrine\postgresql_update_options;
...
final class PostgreSQLDbalLoaderTest extends IntegrationTestCase
{
    public function test_delete_non_existent_rows(): void
    {
        ...
        data_frame()
            ...
            ->load(to_dbal_table_delete($this->postgresqlConnectionParams(), $table))
            ->run();
    ...
    public function test_delete_rows_using_existing_connection(): void
    {
        ...
        data_frame()
            ...
            ->load(to_dbal_table_insert($this->pgsqlDatabaseContext->connection(), $table))
            ->run();

        static::assertEquals(3, $this->pgsqlDatabaseContext->tableCount($table));

        data_frame()
            ->read(from_array([
                ['id' => 2],
            ]))
            ->load(to_dbal_table_delete($this->pgsqlDatabaseContext->connection(), $table))
            ->run();
    ...
    public function test_delete_with_composite_keys(): void
    {
        ...
        static::assertEquals(4, $this->pgsqlDatabaseContext->tableCount($table));
    ...
    public function test_inserts_empty_rows(): void
    {
        ...
        static::assertEquals(0, $this->pgsqlDatabaseContext->tableCount($table));
    }
    ...
    public function test_inserts_multiple_rows_at_once_using_existing_connection(): void
    {
        ...
        static::assertEquals(3, $this->pgsqlDatabaseContext->tableCount($table));
        static::assertEquals(1, $this->pgsqlDatabaseContext->numberOfExecutedInsertQueries());
    }
    ...
    public function test_inserts_new_rows_and_skip_already_existed(): void
    {
        ...
        data_frame()
            ...
            ->load(to_dbal_table_insert(
                ...
                $table,
                PostgreSQLInsertOptions::new()->skipConflicts(),
            ))
            ->run();
    ...
    public function test_inserts_new_rows_or_updates_already_existed_based_on_primary_key(): void
    {
        ...
        data_frame()
            ...
            ->load(to_dbal_table_insert(
                $this->postgresqlConnectionParams(),
                $table,
                PostgreSQLInsertOptions::new()->constraint('flow_doctrine_bulk_test_pkey'),
            ))
            ->run();
    ...
    public function test_update_multiple_rows_at_once(): void
    {
        ...
        $updateLoader = to_dbal_table_update(
            $this->postgresqlConnectionParams(),
            $table,
            postgresql_update_options(primary_key_columns: ['id'], update_columns: ['name']),
        );
