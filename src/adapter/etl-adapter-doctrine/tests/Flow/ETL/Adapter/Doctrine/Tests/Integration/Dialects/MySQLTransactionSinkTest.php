...
final class MySQLTransactionSinkTest extends IntegrationTestCase
{
    public function test_multiple_batches_in_separate_transactions(): void
    {
        ...
        $this->mysqlDatabaseContext->createTable($table);
        ...
        static::assertSame(3, $this->mysqlDatabaseContext->numberOfCommits());
    ...
    public function test_rollback_on_failure(): void
    {
        ...
        $this->mysqlDatabaseContext->createTable($table);
        $this->mysqlDatabaseContext->insert('test_table', ['id' => 1, 'name' => 'Initial']);
        $this->mysqlDatabaseContext->insert('test_table', ['id' => 2, 'name' => 'Initial']);
