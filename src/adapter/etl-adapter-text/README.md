...
- 📜 [Documentation](https://flow-php.com/documentation/components/adapters/text/)
- ➡️ [Installation](https://flow-php.com/documentation/installation/packages/etl-adapter-text/)
