...
final class ParquetExtractorTest extends FlowTestCase
{
    public function test_limit(): void
    {
        ...
        foreach ($extractor->extract(flow_context(config()), new Scan(limit: 2)) as $batch) {
    ...
    public function test_limit_reached_on_the_first_file_tail_batch_skips_the_remaining_files(): void
    {
        ...
        static::assertCount(1000, ExtractedRows::of($extractor, scan: new Scan(limit: 1000)));
    }
    ...
    public function test_the_second_file_is_asked_for_the_remainder_of_the_limit(): void
    {
        ...
        $batches = iterator_to_array($extractor->extract(flow_context(config()), new Scan(limit: 1200)), false);
