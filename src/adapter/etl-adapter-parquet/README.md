...
- 📜 [Documentation](https://flow-php.com/documentation/components/adapters/parquet/)
- ➡️ [Installation](https://flow-php.com/documentation/installation/packages/etl-adapter-parquet/)
