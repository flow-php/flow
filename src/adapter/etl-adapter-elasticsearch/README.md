...
- 📜 [Documentation](https://flow-php.com/documentation/components/adapters/elasticsearch/)
- ➡️ [Installation](https://flow-php.com/documentation/installation/packages/etl-adapter-elasticsearch/)
