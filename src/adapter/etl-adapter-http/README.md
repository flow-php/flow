...
- 📜 [Documentation](https://flow-php.com/documentation/components/adapters/http/)
- ➡️ [Installation](https://flow-php.com/documentation/installation/packages/etl-adapter-http/)
