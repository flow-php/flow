...
final class HttpEncoderTest extends FlowTestCase
{
    ...
    {
        yield 'JSON body decodes to a map' => [
        ...
        yield 'XML body decodes to a navigable map' => [
        ...
        yield 'non JSON/XML body stays a string' => [
            new Response(headers: ['Content-Type' => 'text/plain'], body: 'just text'),
            'just text',
        ];

        yield 'empty body decodes to null' => [
    ...
    #[DataProvider('bodies')]
    public function test_decodes_response_body(ResponseInterface $response, array|string|null $expected): void
    {
