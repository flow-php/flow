...
final readonly class JsonSampledFiles
{
    /**
    ...
    /**
     * Exact when the samples read every row of every listed file.
     */
    public function exactRows(int $listedFiles): Cardinality
    {
        return $this->whole && $this->files === $listedFiles ? Cardinality::exact($this->rows) : Cardinality::unknown();
    }
