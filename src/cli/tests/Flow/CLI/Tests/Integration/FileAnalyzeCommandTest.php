...
│ discount   │ ?float(precision: 6)                                                        │ true     │ {}       │
│ address    │ map<string, string>                                                         │ false    │ {}       │
│ notes      │ list<string>                                                                │ false    │ {}       │
│ items      │ list<structure{sku: string, quantity: integer, price: float(precision: 6)}> │ false    │ {}       │
└────────────┴─────────────────────────────────────────────────────────────────────────────┴──────────┴──────────┘
...
│ discount   │ ?float(precision: 6)                                                        │ 2     │ 3               │ 12.45                     │ 47.10                     │ -          │ -          │ -                  │ -                  │
│ address    │ map<string, string>                                                         │ 0     │ 5               │ -                         │ -                         │ -          │ -          │ 4                  │ 4                  │
│ notes      │ list<string>                                                                │ 0     │ 5               │ -                         │ -                         │ -          │ -          │ 1                  │ 5                  │
│ items      │ list<structure{sku: string, quantity: integer, price: float(precision: 6)}> │ 0     │ 5               │ -                         │ -                         │ -          │ -          │ 2                  │ 4                  │
└────────────┴─────────────────────────────────────────────────────────────────────────────┴───────┴─────────────────┴───────────────────────────┴───────────────────────────┴────────────┴────────────┴────────────────────┴────────────────────┘
OUTPUT,
            $tester->getDisplay()
        );
