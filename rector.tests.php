...
return RectorConfig::configure()
    ...
    ->withConfiguredRule(
        ...
        [
            ...
            // Native Types
            new NewObjectToFunction(ArrayType::class, 'Flow\Types\DSL\type_array'),
            new NewObjectToFunction(BooleanType::class, 'Flow\Types\DSL\type_boolean'),
            new NewObjectToFunction(CallableType::class, 'Flow\Types\DSL\type_callable'),
            new NewObjectToFunction(EnumType::class, 'Flow\Types\DSL\type_enum'),
            new NewObjectToFunction(FloatType::class, 'Flow\Types\DSL\type_float'),
            new NewObjectToFunction(IntegerType::class, 'Flow\Types\DSL\type_integer'),
            new NewObjectToFunction(NullType::class, 'Flow\Types\DSL\type_null'),
            new NewObjectToFunction(InstanceOfType::class, 'Flow\Types\DSL\type_instance_of'),
            new NewObjectToFunction(ResourceType::class, 'Flow\Types\DSL\type_resource'),
            new NewObjectToFunction(StringType::class, 'Flow\Types\DSL\type_string'),

            // Logical Types
            new NewObjectToFunction(DateTimeType::class, 'Flow\Types\DSL\type_datetime'),
            new NewObjectToFunction(DateType::class, 'Flow\Types\DSL\type_date'),
            new NewObjectToFunction(JsonType::class, 'Flow\Types\DSL\type_json'),
            new NewObjectToFunction(ListType::class, 'Flow\Types\DSL\type_list'),
            new NewObjectToFunction(MapType::class, 'Flow\Types\DSL\type_map'),
            new NewObjectToFunction(StructureType::class, 'Flow\Types\DSL\type_structure'),
            new NewObjectToFunction(TimeType::class, 'Flow\Types\DSL\type_time'),
            new NewObjectToFunction(UuidType::class, 'Flow\Types\DSL\type_uuid'),
            new NewObjectToFunction(XMLElementType::class, 'Flow\Types\DSL\type_xml_element'),
            new NewObjectToFunction(XMLType::class, 'Flow\Types\DSL\type_xml'),
            new NewObjectToFunction(HTMLType::class, 'Flow\Types\DSL\type_html'),
            new NewObjectToFunction(HTMLElementType::class, 'Flow\Types\DSL\type_html_element'),
